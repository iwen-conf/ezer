...
//! After [`ezer_pager::minimal_reprint::REPRINT_DEBOUNCE`], minimal clears the screen and scrollback and prints the committed entries again.
//!
//! The clear also drops terminal output from before ezer started and from earlier `/new` sessions.
...
use ezer_pager::minimal_reprint::{self, ReprintDecision};
