...
use ezer_pager::terminal;
use ezer_pager::terminal::overlay::PostFlush;
use ezer_pager::theme::Theme;
use ezer_pager::views::feedback_modal::FeedbackModalState;
...
mod tests {
    use super::*;
    use ezer_pager::views::feedback_modal::OpenFeedbackModal;
    use ezer_pager::views::modal_window;
