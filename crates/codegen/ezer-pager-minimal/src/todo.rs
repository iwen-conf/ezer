...
use ezer_shell::tools::TodoStatus;
    ...
    let mut lines: Vec<Line<'static>> = todos
        ...
        .map(|t| {
            let (glyph, style) = match t.status {
                ...
                TodoStatus::Completed => (ezer_pager::glyphs::check_mark(), theme.muted()),
                TodoStatus::Cancelled => (
                    ezer_pager::glyphs::ballot_x(),
...
mod tests {
    ...
    use ezer_shell::tools::{TodoItem, TodoPriority};
