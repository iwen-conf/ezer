...
use ezer_config::{CampaignEntry, ConfigLayers, env_bool};
...
impl FeatureConfigLayer {
    ...
    pub fn label(self) -> &'static str {
        match self {
            ...
            Self::Overlay => "the EZER_CONFIG overlay",
        }
    }
}
...
pub struct FeatureConfigLayers {
    ...
    /// Beats a user write: the `EZER_CONFIG` overlay, or a campaign patch.
...
pub const FEATURES: &[FeatureSpec] = &[
    ...
    FeatureSpec {
        ...
        env: "EZER_COMPACTION_VERBATIM_INPUT",
        default_enabled: true,
    ...
    FeatureSpec {
        ...
        env: "EZER_SUBAGENT_WORKTREE_SNAPSHOT",
        default_enabled: false,
    ...
    FeatureSpec {
        ...
        env: "EZER_SUBAGENT_MODEL_INHERITANCE",
        default_enabled: false,
    ...
    FeatureSpec {
        ...
        env: "EZER_ACTIVE_AGENT_MESSAGES",
        default_enabled: false,
...
impl Feature {
    ...
    /// Names a tier for the user: `a requirements.toml pin or an MDM policy`, `the EZER_X environment variable`, …
