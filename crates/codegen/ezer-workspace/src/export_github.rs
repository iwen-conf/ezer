...
use ezer_workspace_types::rpc::export_github::{ExportGithubError, ExportGithubResponse};
...
const AUTHOR_NAME: &str = "ezer";
const AUTHOR_EMAIL: &str = "ezer-export@users.noreply.github.com";
...
async fn commit_if_dirty(dir: &Path, message: Option<&str>) -> Result<bool, ExportGithubFailure> {
    ...
    let message = message.unwrap_or("Export from ezer");
