...
use ezer_auth::{AuthCredentialProvider, CredentialSnapshot};
...
static UPLOAD_QUEUE_PENDING_BYTES: LazyLock<IntGauge> = LazyLock::new(|| {
    register_int_gauge!(
        "ezer_workspace_upload_queue_pending_bytes",
...
static UPLOAD_QUEUE_PENDING: LazyLock<IntGauge> = LazyLock::new(|| {
    register_int_gauge!(
        "ezer_workspace_upload_queue_pending",
...
static UPLOAD_FAILED_TOTAL: LazyLock<IntCounterVec> = LazyLock::new(|| {
    register_int_counter_vec!(
        "ezer_workspace_upload_failed_total",
...
static UPLOAD_SKIPPED_TOTAL: LazyLock<IntCounterVec> = LazyLock::new(|| {
    register_int_counter_vec!(
        "ezer_workspace_upload_skipped_total",
...
impl ezer_auth::visibility::HttpAuth for HubAuthCredentialProvider {
...
pub(crate) async fn upload_tool_state_queued(
    ...
    let region = ezer_telemetry::region::Region::from_span(tracing::info_span!(
