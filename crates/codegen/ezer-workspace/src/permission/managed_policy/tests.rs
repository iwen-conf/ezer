...
"#,
    ...
    let user_requirements = ezer_config::RequirementsLayer {
        value: toml::from_str(
            r#"
[[allowed_mcp_servers]]
server_url = "https://ok.example.com/*"
"#,
        ...
        .unwrap(),
        source: ezer_config::RequirementsSource::File(user.path().join("requirements.toml")),
        is_system: false,
    };
    let layers = ezer_config::managed_config_layers_at(Some(system.path()), Some(user.path()));
