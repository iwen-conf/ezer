...
impl From<&ezer_tools::types::ToolInput> for AccessKind {
    fn from(input: &ezer_tools::types::ToolInput) -> Self {
        ...
        match input {
            ...
            ToolInput::UseTool(ezer_tools::implementations::UseToolInput::Inline(u)) => {
                AccessKind::MCPTool {
...
mod tests {
    ...
    fn use_tool_maps_to_mcp_tool_access() {
        use ezer_tools::implementations::use_tool::UseToolInput;
        use ezer_tools::types::ToolInput;
        let input = ToolInput::UseTool(UseToolInput::Inline(
            ezer_tools::implementations::use_tool::InlineMcpInvocation {
    ...
    fn write_scoped_and_dynamic_inputs_map_to_edit_not_read() {
        use ezer_tools::implementations::opencode::edit::EditInput;
        use ezer_tools::types::ToolInput;
