...
//! It deliberately does **not** alias `ezer_sampling_types::SamplingConfig`.
//! Aliasing would pull transitive dependencies on shell-specific types (`ezer-tools`, etc.) into the sampler crate.
