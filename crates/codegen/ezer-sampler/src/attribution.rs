...
//!
//! This crate stays decoupled from `ezer-shell`: no shell types, no auth-manager dependency.

use std::sync::Arc;

pub use ezer_auth::bearer_fragment::BEARER_SUFFIX_LEN;
...
/// This covers sampler endpoints only; tool clients use `ezer_tools::ToolConsumer`.
