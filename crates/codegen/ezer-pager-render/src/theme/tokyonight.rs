...
//!
//! The named constants below match the TokyoNight Night/Storm palette from `ezer-pager/src/ui/style.rs`.
...
// Keep in sync with ezer-pager TokyoNightNight.
#[allow(dead_code)]
pub mod palette {
    use super::*;
...
impl Theme {
    ...
    pub fn faint(&self) -> Style {
        // Lands on the design system's `fg_gutter` token for the EzerNight palette
