...
impl TerminalContext {
    ...
    pub fn telemetry_snapshot(&self) -> ezer_telemetry::events::TerminalTelemetry {
        ...
        ezer_telemetry::events::TerminalTelemetry {
            ...
            clipboard_native_tool: ezer_shared::clipboard::native_tool_name().to_owned(),
            clipboard_data_control: crate::clipboard::wayland_data_control_label().to_owned(),
        }
    }

    /// Extract terminal info for feedback submissions.
    pub fn feedback_info(&self) -> ezer_shared::session::FeedbackTerminalInfo {
        use ezer_shared::session::FeedbackTerminalInfo;
        ...
        FeedbackTerminalInfo {
            ...
            clipboard_native_tool: Some(ezer_shared::clipboard::native_tool_name().to_owned()),
