//! Telemetry engine for ezer sessions.
...
pub(crate) use ezer_otel::otlp;
// Shared redaction utils now live in the foundation crate; re-export keeps `crate::redact_common` paths working.
pub(crate) use ezer_otel::redact_common;
pub use ezer_otel::redact_common::redact_error_detail;
