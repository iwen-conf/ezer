...
use ezer_telemetry::events::SessionNew;
use ezer_telemetry::external::ExternalOtelConfig;
use ezer_telemetry::external::config::ExternalClientInfo;
use ezer_test_support::MockOtelServer;
...
async fn external_stream_carries_no_first_party_credential() {
    ...
    ezer_telemetry::log_event(SessionNew {
