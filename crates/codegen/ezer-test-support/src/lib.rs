...
pub use env::{
    EnvGuard, ensure_cargo_bin_with_features, git_workdir, ezer_binary, isolate_ezer_env,
    set_ezer_binary_override,
};
pub use failure::{
...
pub use tools::{DAEMON_SPAWN_TOOL, EZER_BUILD_SPAWN_TOOL, Tool};
