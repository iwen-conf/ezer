...
mod tests {
    ...
    async fn memory_v2_edit_after_hashline_read_succeeds() {
        ...
        use crate::implementations::ezer_build_hashline::HashlineReadTool;
    ...
    fn anchors_for(content: &str) -> Vec<String> {
        use crate::implementations::ezer_build_hashline::anchor::split_lines;
        use crate::implementations::ezer_build_hashline::edit::apply::anchor_suffix;
        use crate::implementations::ezer_build_hashline::scheme::{AnchorScheme, ChunkFingerprint};
    ...
    fn test_scheme() -> Box<dyn crate::implementations::ezer_build_hashline::scheme::AnchorScheme> {
        crate::implementations::ezer_build_hashline::config::HashlineSchemeParams::default()
            .build_scheme()
            .unwrap()
    }
