...
use crate::implementations::ezer_build::task_output::{
...
impl xai_tool_runtime::Tool for WaitTasksTool {
    ...
    async fn run(
        ...
        let timeout = crate::implementations::ezer_build::task_output::capped_wait_timeout(
            input.timeout_ms,
            crate::implementations::ezer_build::task_output::max_wait_block(),
        );
