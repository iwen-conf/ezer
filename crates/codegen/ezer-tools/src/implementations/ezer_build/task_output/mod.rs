...
use crate::implementations::ezer_build::task::TaskTool;
use crate::implementations::ezer_build::task::backend::SubagentBackendResource;
use crate::implementations::ezer_build::task::types::{SubagentSnapshot, SubagentSnapshotStatus};
use crate::implementations::ezer_build_concise::BashConciseTool;
...
/// The blocking-wait ceiling: `EZER_MAX_WAIT_BLOCK_MS`, else `MAX_WAIT_BLOCK_MS_DEFAULT`. The same
...
pub(crate) fn background_bash_requires_exprs() -> Vec<Expr<ToolRequirement>> {
    ...
    let ezer_build_bash = Expr::Value(ToolRequirement::Tool {
    ...
    let ezer_build_concise_bash = Expr::Value(ToolRequirement::Tool {
    ...
    vec![ezer_build_bash, ezer_build_concise_bash, opencode_bash]
}
...
mod tests {
    ...
    fn resources_with_backend_query() -> (
        ...
        tokio::sync::mpsc::UnboundedReceiver<
            crate::implementations::ezer_build::task::types::SubagentEvent,
        >,
    ) {
        use crate::implementations::ezer_build::task::backend::{
            ChannelBackend, SubagentBackendResource,
        };
        use crate::implementations::ezer_build::task::types::SubagentEvent;
    ...
    fn unwrap_query(
        event: crate::implementations::ezer_build::task::types::SubagentEvent,
    ) -> crate::implementations::ezer_build::task::types::SubagentQueryRequest {
        match event {
            crate::implementations::ezer_build::task::types::SubagentEvent::Query(q) => q,
