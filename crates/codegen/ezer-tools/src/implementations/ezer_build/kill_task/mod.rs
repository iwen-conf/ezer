...
use crate::implementations::ezer_build::task::types::SubagentCancelOutcome;
...
impl crate::types::tool_metadata::ToolMetadata for KillTaskTool {
    ...
    fn requires_expr(&self) -> Expr<ToolRequirement> {
        ...
        let mut arms =
            crate::implementations::ezer_build::task_output::background_bash_requires_exprs();
        arms.push(task_tool);
        Expr::Or(arms)
    }
}
    ...
    fn owned_tasks(owners: &[(&str, Option<&str>)]) -> Vec<TaskSnapshot> {
        owners
            ...
            .map(|(id, owner)| TaskSnapshot {
                ...
                ..crate::implementations::ezer_build::task_output::test_helpers::make_snapshot(
                    id, false, None,
                )
            })
            .collect()
