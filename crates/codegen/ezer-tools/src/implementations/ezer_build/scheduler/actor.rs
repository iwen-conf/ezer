...
mod tests {
    ...
    fn wire_drained_subagents(resources: &mut Resources) {
        ...
        resources.insert(
            crate::implementations::ezer_build::task::types::SessionIdResource(
    ...
    ) -> crate::implementations::ezer_build::task::types::SubagentSnapshot {
        crate::implementations::ezer_build::task::types::SubagentSnapshot {
    ...
    async fn failed_spawn_resets_chain_state() {
        ...
        let _ = request.result_tx.send(
            crate::implementations::ezer_build::task::types::SubagentResult {
                success: false,
