use super::*;
use crate::implementations::ezer_build::task::admission::{LimitBehavior, SubagentLimits};
use crate::implementations::ezer_build::task::backend::{ChannelBackend, SubagentBackend};
...
pub(in crate::implementations::ezer_build::task::coordinator) struct RunnerBehavior {
    pub(in crate::implementations::ezer_build::task::coordinator) wait_before_start: bool,
    pub(in crate::implementations::ezer_build::task::coordinator) fail_wake_before_start: bool,
    pub(in crate::implementations::ezer_build::task::coordinator) reject_wake_after_deferred_start:
        bool,
    pub(in crate::implementations::ezer_build::task::coordinator) wait_after_cancel: bool,
    pub(in crate::implementations::ezer_build::task::coordinator) hold_terminal_publication: bool,
    pub(in crate::implementations::ezer_build::task::coordinator) hold_failed_wake_teardown: bool,
    /// Type returned for a resume source that is not in the completed map.
    pub(in crate::implementations::ezer_build::task::coordinator) durable_resume_type:
        Option<&'static str>,
}
...
impl ChildRunner for TestRunner {
    ...
    type RootControl = crate::implementations::ezer_build::task::root_control::NoRootControl;
...
pub(in crate::implementations::ezer_build::task::coordinator) fn request(
    id: &str,
    background: bool,
) -> SubagentRequest {
    SubagentRequest {
...
pub(in crate::implementations::ezer_build::task::coordinator) struct Harness {
    pub(in crate::implementations::ezer_build::task::coordinator) backend: ChannelBackend,
    pub(in crate::implementations::ezer_build::task::coordinator) start:
        tokio::sync::broadcast::Sender<()>,
    pub(in crate::implementations::ezer_build::task::coordinator) finish:
        tokio::sync::broadcast::Sender<()>,
    pub(in crate::implementations::ezer_build::task::coordinator) finish_one:
        tokio::sync::broadcast::Sender<String>,
    pub(in crate::implementations::ezer_build::task::coordinator) completions:
        mpsc::UnboundedReceiver<CompletionDisposition>,
    pub(in crate::implementations::ezer_build::task::coordinator) failed_wake_teardown_ready:
        mpsc::UnboundedReceiver<()>,
    pub(in crate::implementations::ezer_build::task::coordinator) terminal_publications:
        mpsc::UnboundedReceiver<Box<dyn FnOnce() + Send>>,
    pub(in crate::implementations::ezer_build::task::coordinator) requests:
        mpsc::UnboundedReceiver<SubagentRequest>,
    pub(in crate::implementations::ezer_build::task::coordinator) started:
        mpsc::UnboundedReceiver<String>,
    pub(in crate::implementations::ezer_build::task::coordinator) resume_sources:
        mpsc::UnboundedReceiver<SubagentResumeLookup>,
    pub(in crate::implementations::ezer_build::task::coordinator) queue_waits:
        mpsc::UnboundedReceiver<(String, Option<std::time::Duration>, usize)>,
    pub(in crate::implementations::ezer_build::task::coordinator) advertise_targets:
        mpsc::UnboundedReceiver<(String, Option<String>)>,
    pub(in crate::implementations::ezer_build::task::coordinator) wake_runs:
        mpsc::UnboundedReceiver<WakeRun>,
    pub(in crate::implementations::ezer_build::task::coordinator) admitted_messages:
        mpsc::UnboundedReceiver<(ActiveAgentMessageOperation, String)>,
    pub(in crate::implementations::ezer_build::task::coordinator) actor: tokio::task::JoinHandle<()>,
}

pub(in crate::implementations::ezer_build::task::coordinator) fn harness(
...
pub(in crate::implementations::ezer_build::task::coordinator) fn harness_with_config(
    wait_before_start: bool,
...
pub(in crate::implementations::ezer_build::task::coordinator) fn harness_with_options(
    behavior: RunnerBehavior,
    config: CoordinatorConfig,
) -> Harness {
...
pub(in crate::implementations::ezer_build::task::coordinator) fn parent_backend(
    harness: &Harness,
) -> ChannelBackend {
...
pub(in crate::implementations::ezer_build::task::coordinator) fn buffering() -> CoordinatorConfig {
    CoordinatorConfig {
        buffer_completions: true,
        ..CoordinatorConfig::default()
    }
...
pub(in crate::implementations::ezer_build::task::coordinator) async fn buffered_completions(
    harness: &Harness,
    session: Option<&str>,
) -> Vec<crate::implementations::ezer_build::task::types::SubagentCompletionSummary> {
...
pub(in crate::implementations::ezer_build::task::coordinator) fn limited(
...
pub(in crate::implementations::ezer_build::task::coordinator) async fn await_queued(
    backend: &ChannelBackend,
    queued: usize,
) {
    for _ in 0..400 {
