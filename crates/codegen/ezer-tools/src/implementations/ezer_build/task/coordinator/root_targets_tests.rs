...
use crate::implementations::ezer_build::task::coordinator::agent_targets::tests::holder;
use crate::implementations::ezer_build::task::coordinator::{
    ActiveMessageAdmission, SendBoxFuture,
};
use crate::implementations::ezer_build::task::root_control::{
...
fn begin(
    ...
    tx: &crate::implementations::ezer_build::task::backend::SubagentCoordinatorSender,
...
async fn root_resolution_routes_and_completion_are_exact() {
    ...
    coordinator.terminal_outputs.insert(
        CHILD.to_owned(),
        crate::implementations::ezer_build::task::coordinator::ChildRunOutput {
            result: crate::implementations::ezer_build::task::types::SubagentResult {
                success: true,
