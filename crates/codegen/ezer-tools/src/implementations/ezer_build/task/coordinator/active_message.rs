...
use crate::implementations::ezer_build::task::active_message::{
...
pub use crate::implementations::ezer_build::task::root_control::AgentMessageGeneration as ActiveChildGeneration;
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(in crate::implementations::ezer_build::task) enum TerminalDrainDisposition {
    Clean,
    Uncertain,
}
...
pub(in crate::implementations::ezer_build::task) enum ActiveMessageLifecycle {
    Open {
        in_flight: usize,
...
pub(super) enum ActiveMessageCompletionTarget {
    ...
    Root(crate::implementations::ezer_build::task::coordinator::root_targets::RootTargetKey),
}
...
impl<R: ChildRunner> SubagentCoordinator<R> {
    ...
    pub(super) fn resolve_address_send(
        &mut self,
        address: &crate::implementations::ezer_build::task::types::AgentAddress,
        sender_session_id: &str,
        resolved_target: Option<&TargetIncarnationKey>,
    ) -> ResolvedSend {
        ...
        let address_hit =
            |stored: &Option<crate::implementations::ezer_build::task::types::AgentAddress>| {
                stored
                    .as_ref()
