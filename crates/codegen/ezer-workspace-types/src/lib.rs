//! Wire types for the `ezer-workspace` API.
//!
...
//! That codegen step is **not** implemented yet; it will land alongside the `ezer-workspace-grpc` crate.
...
/// Re-exported by `ezer_workspace::permission` for callers that historically imported it from there.
