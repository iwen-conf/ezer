...
//! agent-session config types in `ezer-config` and friends.
...
/// TODO: align with the MCP/tool-server config in `ezer-tools` once the wire surface is firm.
...
///
/// TODO: align with `ezer_config::ProjectConfig`.
#[derive(Debug, Clone, Default, PartialEq, Eq, Serialize, Deserialize)]
