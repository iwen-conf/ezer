...
pub enum PluginOrigin {
    ...
    /// ezer's install registry (marketplace or direct git/local install).
    MarketplaceInstall {
...
pub struct HookInfo {
    ...
    /// Whether dispatch skips this hook: `enabled = false`, listed in ~/.ezer/disabled-hooks, or kept off by `allow_managed_hooks_only`.
    #[serde(default)]
    pub disabled: bool,
