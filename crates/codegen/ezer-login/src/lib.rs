...
//!
//! Extracted from `ezer-shell::auth`; the shell re-exports this crate as
//! `ezer_shell::auth` so existing `crate::*` paths keep resolving.
#![deny(clippy::indexing_slicing)]
pub use ezer_telemetry::unified_log;
...
pub use ezer_config_types::AuthProviderConfig;
pub mod meta;
