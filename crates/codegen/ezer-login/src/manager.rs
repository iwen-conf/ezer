...
use ezer_shell_base::util::dual_clock::DualClock;
use ezer_telemetry::events::ManualAuthSurface;
...
impl AuthManager {
    ...
    pub async fn update(self: &Arc<Self>, auth: EzerAuth) -> std::io::Result<EzerAuth> {
        ...
        match &write_result {
            Ok(()) => ezer_telemetry::unified_log::info(
            ...
            Err(e) => ezer_telemetry::unified_log::error(
    ...
    #[cfg(test)]
    pub fn manual_auth_last_emit(&self) -> Option<ezer_telemetry::events::ManualAuth> {
...
impl ezer_tools::types::ApiKeyProvider for SharedAuthKeyProvider {
...
) -> ezer_tools::types::SharedApiKeyProvider {
