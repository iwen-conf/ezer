//! Extracts the pure-logic "resolution" phase of subagent spawning from `ezer-shell` into a reusable library.
...
//! It serves local hosts (e.g. `ezer-shell`) and any future remote spawn path that needs only pure resolution logic.
//!
