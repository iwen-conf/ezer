...
/// Public because `ezer-shell` calls it.
...
impl ezer_compaction::CompactionItemFactory for ConversationItem {
...
mod compaction_item_bridge_tests {
    use super::*;
    use ezer_compaction::{CompactionItem, CompactionItemFactory, CompactionRole};
