...
impl From<ConversationRequest> for ChatCompletionRequest {
    fn from(req: ConversationRequest) -> Self {
        ...
        ChatCompletionRequest {
            ...
            tools,
            tool_choice,
            parallel_tool_calls: (!tools_is_empty).then_some(true),
            search_parameters: None,
            response_format,
            reasoning_effort: req.reasoning_effort,
            x_ezer_conv_id: req.x_ezer_conv_id,
            x_ezer_req_id: req.x_ezer_req_id,
            x_ezer_session_id: req.x_ezer_session_id,
            x_ezer_turn_idx: req.x_ezer_turn_idx,
            x_ezer_transient_retry: req.x_ezer_transient_retry,
            x_ezer_agent_id: req.x_ezer_agent_id,
            x_ezer_deployment_id: req.x_ezer_deployment_id,
            x_ezer_user_id: req.x_ezer_user_id,
            trace: None,
