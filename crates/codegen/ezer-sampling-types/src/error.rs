//! TODO: Move from ezer-shell/src/sampling/error.rs
...
pub use ezer_compaction::is_context_length_error;
...
mod tests {
    ...
    // The canonical wording table lives beside the detector in ezer-compaction; tests here pin only crate-local couplings
    #[test]
