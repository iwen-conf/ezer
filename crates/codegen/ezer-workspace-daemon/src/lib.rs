...
//!
//! Two halves of one concern, both used only by the `xai-workspace-server` binary and never by the `ezer-workspace` library:
//!
...
//!
//! This crate deliberately does not depend on `ezer-workspace`.
