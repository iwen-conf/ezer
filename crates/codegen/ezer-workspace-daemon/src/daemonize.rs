...
/// Private flock-contention check; the bounded replacement lives in `ezer-file-lock` and this site migrates to it later.
...
mod tests {
    ...
    fn process_name_matches_own_argv0() {
        ...
        // Different test runners name the binary differently (e.g. Cargo uses `ezer_workspace_daemon-<hash>`).
