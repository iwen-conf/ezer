...
pub const FREE_USAGE_USER_MESSAGE: &str = "You\u{2019}ve reached your free ezer usage limit for now. Get SuperGrok for much higher limits, or try again later: https://grok.com/supergrok?referrer=ezer-build";
