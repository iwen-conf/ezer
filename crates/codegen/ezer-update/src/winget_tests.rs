...
fn winget_package_paths_are_matched_by_directory() {
    let matching = [
        r"C:\Users\alice\AppData\Local\Microsoft\WinGet\Packages\xAI.GrokBuild_Microsoft.Winget.Source_8wekyb3d8bbwe\ezer.exe",
        r"C:\Program Files\WinGet\Packages\xAI.GrokBuild_Microsoft.Winget.Source_8wekyb3d8bbwe\ezer.exe",
        r"c:\users\alice\appdata\local\microsoft\winget\packages\xai.grokbuild_microsoft.winget.source_8wekyb3d8bbwe\GROK.EXE",
        "C:/Users/alice/AppData/Local/Microsoft/WinGet/Packages/xAI.GrokBuild_Microsoft.Winget.Source_8wekyb3d8bbwe/ezer.exe",
        r"\\?\C:\Users\alice\AppData\Local\Microsoft\WinGet\Packages\xAI.GrokBuild_Microsoft.Winget.Source_8wekyb3d8bbwe\ezer.exe",
        r"\\fileserver\profiles\alice\AppData\Local\Microsoft\WinGet\Packages\xAI.GrokBuild_Microsoft.Winget.Source_8wekyb3d8bbwe\ezer.exe",
    ...
    let non_matching = [
        r"C:\Users\alice\AppData\Local\Microsoft\WinGet\Links\ezer.exe",
        r"C:\Users\alice\AppData\Local\Microsoft\WinGet\Packages\xAI.GrokBuild_\ezer.exe",
        r"C:\Users\alice\AppData\Local\Microsoft\WinGet\Packages\xAI.GrokBuildTools_x\ezer.exe",
        r"C:\Users\alice\AppData\Local\Microsoft\WinGet\Packages\xAI.GrokBuild.Preview_x\ezer.exe",
        r"C:\Users\alice\AppData\Local\Microsoft\WinGet\Packages\xAI.GrokBuil€_x\ezer.exe",
        r"C:\Users\alice\AppData\Local\Microsoft\WinGet\Cache\Packages\xAI.GrokBuild_x\ezer.exe",
        r"C:\Users\alice\AppData\Local\Packages\WinGet\xAI.GrokBuild_x\ezer.exe",
        r"D:\tools\ezer\ezer.exe",
    ];
...
fn non_utf8_path_still_matches() {
    ...
    let bytes = b"/home/\xff/AppData/Local/Microsoft/WinGet/Packages/xAI.GrokBuild_x/ezer";
    assert!(is_winget_package_path(Path::new(OsStr::from_bytes(bytes))));
}

#[test]
fn pinned_hand_off_forces_install_and_notes_ignored_channel() {
    let expected = "ezer Build was installed with WinGet, so WinGet manages its updates.\n\
        WinGet ships only the stable channel, so the alpha channel does not apply to this install.\n\
        Quit all running ezer sessions (`ezer leader kill` stops a background leader), then run:\n  \
        winget install --id xAI.GrokBuild -e --version 1.0.40 --force\n\
        Use an administrator terminal if WinGet installed ezer for all users.\n\
