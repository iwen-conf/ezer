...
//! `WorkspaceOps` proxy mode and consumers that cannot depend on `ezer-workspace` both use it.
//! Wire types live in `ezer_workspace_types::rpc`.
...
use ezer_workspace_types::rpc::agents_md::{AgentConfigFile, DiscoverAgentsMdReq};
use ezer_workspace_types::rpc::code_nav::{
...
use ezer_workspace_types::rpc::export_github::{ExportGithubReq, ExportGithubResponse};
...
use ezer_workspace_types::rpc::git::{
...
use ezer_workspace_types::rpc::hunks::{
...
use ezer_workspace_types::rpc::search::{
    ContentSearchData, ContentSearchRequest, FuzzyChangeReq, FuzzyCloseReq, FuzzyOpenReq,
    FuzzyStatusReq,
};
use ezer_workspace_types::rpc::session::{
    BeginPromptReq, EndPromptReq, FileRewindResponse, RewindToReq,
};
use ezer_workspace_types::rpc::skills::{DiscoverPluginsReq, DiscoverSkillsReq, SkillInfo};
...
use ezer_workspace_types::rpc::worktree::{
...
use ezer_workspace_types::rpc::{RpcEnvelope, RpcError, WORKSPACE_RPC_TOOL_ID, WorkspaceRpc};
...
mod tests {
    ...
    use ezer_workspace_types::rpc::RpcActivityClass;
