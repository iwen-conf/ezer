...
//! [`ContentController`] wraps the shared [`MockInferenceServer`] from `ezer-test-support`.
...
use ezer_test_support::{MockInferenceServer, TestSandbox};
...
mod tests {
    ...
    /// A 404 strands the pager on the MaxTier upsell screen and breaks every PTY test.
    #[tokio::test]
