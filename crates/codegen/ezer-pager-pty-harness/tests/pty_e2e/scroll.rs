...
use ezer_pager_pty_harness::PtyHarness;
pub(crate) use ezer_pager_pty_harness::{SGR_SCROLL_DOWN, SGR_SCROLL_UP};
...
/// [`spawn_bottom_pinned_marker_scrollback`] with extra pager env vars (e.g. `EZER_SCROLL_SPEED`) appended to the controller's env.
