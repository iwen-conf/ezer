//! Criterion benchmarks for the ezer-pager rendering pipeline.
//!
...
use ezer_pager::scrollback::render::render_scrolled_entries_with_scratch;
use ezer_pager::scrollback::wrappers::EntryRenderer;
use ezer_pager::scrollback::{
