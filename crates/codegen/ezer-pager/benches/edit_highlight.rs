...
//!
//! ```text
//! cargo bench -p ezer-pager --bench edit_highlight
//! cargo bench -p ezer-pager --bench edit_highlight -- edit_hl/upgrade
//! ```
...
use ezer_pager::scrollback::blocks::tool::{
...
use ezer_pager::syntax::{Syntect, get_syntect};
use ezer_pager::theme::Theme;
use ezer_pager_diff::{DiffHunk, DiffLine};
