...
Fear not — your settings, rules, and skills come with you. ezer
...
writes the items you selected into your `.ezer` config. Re-run it anytime.
...
Run **`ezer inspect`** in a repo to see every rules file, skill, and MCP
server ezer picked up, tagged with where it came from. Each compat source
