...
Want ezer working on a feature while you (or another ezer session) work on
...
- **From the shell:**
  ...
  ```bash
  ezer --worktree=my-feature "refactor the auth module"
  ```
...
- Run two or three ezer sessions on the same repo simultaneously.
