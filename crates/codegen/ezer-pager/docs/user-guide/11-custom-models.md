...
Subagents (`spawn_subagent`) work on this BYOK path: children inherit the active catalog model unless `[subagents.models]` pins a key. See [Subagents](16-subagents.md).
