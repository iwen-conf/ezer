//! `ezer usage <session-id> [turn]`: persisted token/cost usage.

use std::io::Write;

use anyhow::{Context, Result};
use ezer_shell::session::usage_file::{SessionUsageFile, UsageLoad};
...
mod tests {
    use super::*;
    use ezer_shell::session::usage_file::UsageSummary;
