...
impl From<ezer_shell::util::config::WorktreeHintMode> for WorktreeMode {
    fn from(mode: ezer_shell::util::config::WorktreeHintMode) -> Self {
        use ezer_shell::util::config::WorktreeHintMode;
        match mode {
...
impl WorktreeMode {
    ...
    pub fn from_config_str(s: &str) -> Self {
        ezer_shell::util::config::WorktreeHintMode::from_config_str(s).into()
    }
    ...
    pub fn resolve_from_hints_value(hints: Option<&toml::Value>) -> (Self, Self) {
        let (new_session, fork) =
            ezer_shell::util::config::WorktreeHintMode::resolve_pair(hints);
...
fn is_restricted_tier(tier: Option<&str>) -> bool {
    match tier {
        None => true,
        Some(t) => ezer_shell::tier::is_restricted_tier_name(t),
    }
}
...
pub struct AppView {
    ...
    pub pending_startup: Option<ezer_telemetry::startup::PendingStartup>,
    ...
    pub current_ui: ezer_shell::agent::config::UiConfig,
    pub cwd: PathBuf,
    ...
    pub active_announcements: Vec<ezer_announcements::RemoteAnnouncement>,
    ...
    pub announcement: Option<ezer_announcements::RemoteAnnouncement>,
    ...
    /// Default-empty and inert outside `--minimal`; the `ezer-pager-minimal` crate reads/mutates it through the `crate::minimal_api` accessors.
    ...
    pub session_picker_content_results:
        Option<Vec<ezer_shell::extensions::session_search::SearchSessionHit>>,
    ...
    pub(crate) foreign_session_compat: ezer_foreign_sessions::EnabledForeignSessionSources,
    ...
    pub contextual_hints: ezer_shell::util::config::ResolvedContextualHints,
    ...
    pub remote_contextual_hints: Option<ezer_shell::util::config::ContextualHintsRemote>,
    ...
    pub pending_gate_verification: Option<ezer_login::GateInfo>,
...
impl AppView {
    ...
    pub(crate) fn finish_startup(&mut self, outcome: ezer_telemetry::startup::StartupOutcome) {
        ezer_telemetry::startup::PendingStartup::finish_held(
    ...
    pub fn gate_from_settings(
        rs: &ezer_shell::util::config::RemoteSettings,
    ) -> Option<ezer_login::GateInfo> {
        let msg = rs.gate_message.as_ref()?;
        if msg.is_empty() {
            return None;
        }
        Some(ezer_login::GateInfo {
            message: msg.clone(),
    ...
    pub fn apply_auth_meta(&mut self, meta: &ezer_login::AuthMeta) {
        ...
        if was_gated && self.gate.is_none() {
            ...
            ezer_telemetry::session_ctx::log_event(
                ezer_telemetry::events::SubscriptionActivated {
    ...
    pub fn new(
        ...
        Self {
            ...
            current_ui: ezer_shell::agent::config::UiConfig::default(),
            ...
            auto_mode_gate: ezer_shell::util::config::auto_permission_mode_enabled_from_disk(),
            ...
            voice_config: ezer_voice::VoiceConfig::default(),
            voice_auth: None,
            voice_cmd_tx: None,
    ...
    pub fn voice_can_start_pipeline(&self) -> bool {
        self.voice_mode_enabled && ezer_voice::AUDIO_SUPPORTED
    }
    ...
    fn voice_send(&self, cmd: ezer_voice::VoiceCommand) {
    ...
    pub(crate) fn voice_begin_recording(&mut self, target: VoiceTarget, hold: bool) {
        self.voice_send(ezer_voice::VoiceCommand::PttPress);
    ...
    pub(crate) fn voice_stop_keeping_final(&mut self) {
        ...
        self.voice_send(ezer_voice::VoiceCommand::PttRelease);
...
struct WelcomeInputCtx<'a> {
    ...
    sp_content_results:
        &'a Option<Vec<ezer_shell::extensions::session_search::SearchSessionHit>>,
        ...
        if matches!(ctx.auth_state, AuthState::Done) {
            if ctx.upgrade_cta_keyboard && key!('o', CONTROL).matches(key) {
                return InputOutcome::Action(Action::AnnouncementsOpenCta(
                    ezer_telemetry::events::AnnouncementCtaSurface::Keyboard,
                ));
            }
    ...
    if let Event::Mouse(mouse) = ev {
        ...
        match mouse.kind {
            MouseEventKind::Down(MouseButton::Left) => {
                ...
                {
                    return InputOutcome::Action(Action::AnnouncementsOpenCta(
                        ezer_telemetry::events::AnnouncementCtaSurface::Welcome,
                    ));
                }
...
impl AppView {
    ...
    pub fn draw(&mut self, terminal: &mut PagerTerminal) {
        ...
        ezer_telemetry::startup::record_first_draw();
    ...
    /// Log [`ezer_telemetry::events::AnnouncementCtaShown`] for each surface whose CTA button is painted this frame.
    ...
    pub(crate) fn log_announcement_cta_impressions(&mut self) {
        ...
        let key = ezer_announcements::announcement_hide_key(owner);
        ...
        for (surface, _) in surfaces.into_iter().filter(|(_, painted)| *painted) {
            ...
            {
                ezer_telemetry::session_ctx::log_event(
                    ezer_telemetry::events::AnnouncementCtaShown {
                        id: id.clone(),
                        source: surface,
                    },
                );
...
impl AppView {
    ...
    pub fn apply_contextual_hints(
        &mut self,
        resolved: ezer_shell::util::config::ResolvedContextualHints,
    ) {
    ...
    fn apply_clipboard_probe(
        ...
        if agent.show_ephemeral_tip(
            ...
            ezer_telemetry::session_ctx::log_event(ezer_telemetry::events::ContextualTip {
                tip: ezer_telemetry::events::ContextualTipKind::ImageInput,
                action: ezer_telemetry::events::ContextualTipAction::Shown,
            });
            return true;
        }
        false
