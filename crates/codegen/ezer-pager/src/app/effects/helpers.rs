...
use ezer_telemetry::events::ClipboardProbeDropReason;
use super::actions::{
    PermissionModePersist, ProbedAttachment, SubagentKillOutcome, TaskResult,
};
use super::agent::AgentId;
use crate::unified_log as ulog;
use ezer_shell::sampling::error::{
...
use ezer_shell::session::ExtMethodResult;
use ezer_shell::session::helpers::session_compact::{
...
pub(super) fn session_rpc_timeout() -> std::time::Duration {
    SESSION_RPC_FLOOR.max(ezer_workspace::envrc::loader_budget() + SESSION_RPC_SLACK)
}
...
pub(super) async fn memory_command_request<T: serde::de::DeserializeOwned>(
    ...
    let body = ezer_shell::extensions::memory::MemoryFlushRequest {
...
) -> (bool, Option<String>, Option<ezer_workspace::session::git::RestoreDegree>) {
...
pub(crate) fn parse_worktree_strategy_summary(
    ...
    ezer_workspace::worktree::StrategyReport::deserialize(strategy).ok()?.notice()
}
...
pub(crate) fn parse_session_memory_mode(
    ...
    resp_meta
        .and_then(|meta| meta.get(ezer_shell::session::MEMORY_MODE_META_KEY))
        .cloned()
...
pub(crate) fn sanitize_user_error(raw: &str) -> String {
    ...
    let mut result = ezer_shell::sampling::error::rewrite_service_names(raw);
...
pub(super) fn extract_first_user_prompt(
    info: &ezer_shell::session::info::Info,
) -> Option<String> {
    use std::io::BufRead;
    let history_path = ezer_shell::session::persistence::session_dir(info)
...
pub(super) async fn send_hydrate_team_capability(
    ...
    use ezer_shell::extensions::auth::{
    ...
    let can_administer_team = match serde_json::value::to_raw_value(&params) {
        Ok(raw) => {
            let req = acp::ExtRequest::new(
                "ezer/auth/hydrate_team_capability",
                raw.into(),
            );
            match acp_send(req, tx).await {
                Ok(resp) => {
...
pub(crate) async fn persist_setting(
    ...
    match key {
        "compact_mode" => {
            ...
            ezer_shell::util::config::set_compact_mode(b)
                .await
        ...
        "trace_upload" => {
            ...
            ezer_shell::util::config::set_trace_upload(b)
                .await
                .map_err(|e| e.to_string())
        }
        "feedback_trace_card" => {
            ...
            ezer_shell::util::config::set_feedback_trace_card(b)
                .await
                .map_err(|e| e.to_string())
        }
        "show_timestamps" => {
            ...
            ezer_shell::util::config::set_show_timestamps(b)
                .await
                .map_err(|e| e.to_string())
        }
        "dashboard_preview" => {
            ...
            ezer_shell::util::config::set_dashboard_preview(enabled)
                .await
        ...
        "page_flip_on_send" => {
            ...
            ezer_shell::util::config::set_page_flip_on_send(b)
                .await
                .map_err(|e| e.to_string())
        }
        "confirm_before_rewind" => {
            ...
            ezer_shell::util::config::set_confirm_before_rewind(b)
                .await
                .map_err(|e| e.to_string())
        }
        "combine_queued_prompts" => {
            ...
            ezer_shell::util::config::set_combine_queued_prompts(b)
                .await
                .map_err(|e| e.to_string())
        }
        "follow_up_behavior" => {
            ...
            ezer_shell::util::config::set_follow_up_behavior(s.to_string())
                .await
                .map_err(|e| e.to_string())
        }
        "show_timeline" => {
            ...
            ezer_shell::util::config::set_show_timeline(b)
                .await
                .map_err(|e| e.to_string())
        }
        "simple_mode" => {
            ...
            ezer_shell::util::config::set_simple_mode(b)
                .await
                .map_err(|e| e.to_string())
        }
        "contextual_hints.undo" => {
            ...
            ezer_shell::util::config::set_contextual_hint_undo(b)
                .await
                .map_err(|e| e.to_string())
        }
        "contextual_hints.plan_mode" => {
            ...
            ezer_shell::util::config::set_contextual_hint_plan_mode(b)
                .await
                .map_err(|e| e.to_string())
        }
        "contextual_hints.image_input" => {
            ...
            ezer_shell::util::config::set_contextual_hint_image_input(b)
                .await
                .map_err(|e| e.to_string())
        }
        "contextual_hints.send_now" => {
            ...
            ezer_shell::util::config::set_contextual_hint_send_now(b)
                .await
                .map_err(|e| e.to_string())
        }
        "contextual_hints.small_screen" => {
            ...
            ezer_shell::util::config::set_contextual_hint_small_screen(b)
                .await
                .map_err(|e| e.to_string())
        }
        "contextual_hints.word_select" => {
            ...
            ezer_shell::util::config::set_contextual_hint_word_select(b)
                .await
                .map_err(|e| e.to_string())
        }
        "contextual_hints.export_copy" => {
            ...
            ezer_shell::util::config::set_contextual_hint_export_copy(b)
                .await
                .map_err(|e| e.to_string())
        }
        "contextual_hints.ssh_wrap" => {
            ...
            ezer_shell::util::config::set_contextual_hint_ssh_wrap(b)
                .await
                .map_err(|e| e.to_string())
        }
        "theme" => {
            ...
            ezer_shell::util::config::set_theme(s.to_string())
                .await
                .map_err(|e| e.to_string())
        }
        "auto_dark_theme" => {
            ...
            ezer_shell::util::config::set_auto_dark_theme(s.to_string())
                .await
                .map_err(|e| e.to_string())
        }
        "auto_light_theme" => {
            ...
            ezer_shell::util::config::set_auto_light_theme(s.to_string())
                .await
                .map_err(|e| e.to_string())
        }
        "default_model" => {
            ...
            ezer_shell::util::config::set_default_model(s)
                .await
                .map_err(|e| e.to_string())
        }
        "scroll_speed" => {
            ...
            ezer_shell::util::config::set_scroll_speed(i)
                .await
                .map_err(|e| e.to_string())
        }
        "scroll_mode" => {
            ...
            ezer_shell::util::config::set_scroll_mode(s.to_string())
                .await
                .map_err(|e| e.to_string())
        }
        "invert_scroll" => {
            ...
            ezer_shell::util::config::set_invert_scroll(b)
                .await
                .map_err(|e| e.to_string())
        }
        "display_refresh_auto_cadence" => {
            ...
            ezer_shell::util::config::set_display_refresh_auto_cadence(b)
                .await
                .map_err(|e| e.to_string())
        }
        "scroll_lines" => {
            ...
            ezer_shell::util::config::set_scroll_lines(i)
                .await
                .map_err(|e| e.to_string())
        }
        "default_selected_permission" => {
            ...
            ezer_shell::util::config::set_default_selected_permission(s.to_string())
                .await
                .map_err(|e| e.to_string())
        }
        "cancel_subagents_on_turn_cancel" => {
            ...
            ezer_shell::util::config::set_cancel_subagents_on_turn_cancel(
                    s.to_string(),
                )
                .await
                .map_err(|e| e.to_string())
        ...
        "vim_mode" => {
            ...
            ezer_shell::util::config::set_vim_mode(b)
                .await
                .map_err(|e| e.to_string())
        }
        "remember_tool_approvals" => {
            ...
            ezer_shell::util::config::set_remember_tool_approvals(b)
                .await
                .map_err(|e| e.to_string())
        }
        "toolset.ask_user_question.timeout_enabled" => {
            ...
            ezer_shell::util::config::set_ask_user_question_timeout_enabled(b)
                .await
                .map_err(|e| e.to_string())
        }
        "show_thinking_blocks" => {
            ...
            ezer_shell::util::config::set_show_thinking_blocks(b)
                .await
                .map_err(|e| e.to_string())
        }
        "group_tool_verbs" => {
            ...
            ezer_shell::util::config::set_group_tool_verbs(b)
                .await
                .map_err(|e| e.to_string())
        }
        "collapsed_edit_blocks" => {
            ...
            ezer_shell::util::config::set_collapsed_edit_blocks(b)
                .await
                .map_err(|e| e.to_string())
        }
        "prompt_suggestions" => {
            ...
            ezer_shell::util::config::set_prompt_suggestions(b)
                .await
                .map_err(|e| e.to_string())
        }
        "keep_text_selection" => {
            ...
            ezer_shell::util::config::set_keep_text_selection(s.to_string())
                .await
                .map_err(|e| e.to_string())
        }
        ...
        "render_mermaid" => {
            ...
            ezer_shell::util::config::set_render_mermaid(s.to_string())
                .await
                .map_err(|e| e.to_string())
        }
        "hunk_tracker_mode" => {
            ...
            ezer_shell::util::config::set_hunk_tracker_mode(s.to_string())
                .await
                .map_err(|e| e.to_string())
        }
        "screen_mode" => {
            ...
            ezer_shell::util::config::set_screen_mode(s.to_string())
                .await
                .map_err(|e| e.to_string())
        }
        "voice_keybind_enabled" => {
            ...
            ezer_shell::util::config::set_voice_keybind_enabled(b)
                .await
                .map_err(|e| e.to_string())
        }
        "voice_capture_mode" => {
            ...
            ezer_shell::util::config::set_voice_capture_mode(s.to_string())
                .await
                .map_err(|e| e.to_string())
        }
        "voice_stt_language" => {
            ...
            ezer_shell::util::config::set_voice_stt_language(s.to_string())
                .await
                .map_err(|e| e.to_string())
        }
        "max_thoughts_width" => {
            ...
            ezer_shell::util::config::set_max_thoughts_width(i)
                .await
                .map_err(|e| e.to_string())
        }
        "show_tips" => {
            ...
            ezer_shell::util::config::set_show_tips(b)
                .await
                .map_err(|e| e.to_string())
        }
        "auto_update" => {
            ...
            ezer_shell::util::config::set_auto_update(b)
                .await
                .map_err(|e| e.to_string())
        }
        "fork_secondary_model" => {
            ...
            ezer_shell::util::config::set_fork_secondary_model(s)
                .await
                .map_err(|e| e.to_string())
        }
...
pub(crate) async fn persist_permission_mode_and_notify(
    ...
    let disk_result = ezer_shell::util::config::update_config(|cfg| {
...
pub(super) fn parse_kill_outcome(
    resp: &str,
) -> Option<ezer_tools::types::KillOutcome> {
    use ezer_shell::extensions::task::KillTaskResponse;
    use ezer_shell::session::result::ExtMethodResult;
...
pub(super) fn parse_subagent_kill_outcome(resp: &str) -> SubagentKillOutcome {
    use ezer_shell::extensions::task::{
...
pub(super) fn credit_balance_from_config(
    c: ezer_shell::extensions::billing::BillingConfig,
...
pub(super) fn parse_auto_topup_response(
    ...
    use ezer_shell::extensions::billing::GetAutoTopupRuleResponse;
...
pub(super) fn unregister_active_session_best_effort_in(
    ...
    match ezer_active_sessions::try_unregister_in(root, session_id) {
        Ok(true) => {}
        Ok(false) => {
            tracing::debug!(
