...
use ezer_telemetry::events::ExtensionsInputMethod;
...
impl AgentView {
    ...
    fn log_extensions_modal_action(
        &self,
        action: &str,
        input_method: ezer_telemetry::events::ExtensionsInputMethod,
    ) {
    ...
    fn log_extensions_modal_action_with(
        ...
        if let Some(ref state) = self.extensions_modal {
            ezer_telemetry::session_ctx::log_event(
                ezer_telemetry::events::ExtensionsModalAction {
    ...
    pub(super) fn handle_extensions_modal_key(
            ...
            })
        {
            self.log_extensions_modal_action(
                "open_connectors",
                ezer_telemetry::events::ExtensionsInputMethod::Keyboard,
            );
        ...
        if let Some(ch) = chrome_shortcut_ch {
                ...
                .and_then(|s| crate::views::extensions_modal::resolve_key(s.active_tab, ch))
            {
                self.log_extensions_modal_resolved_action(
                    ch,
                    &action,
                    ezer_telemetry::events::ExtensionsInputMethod::Mouse,
                );
...
mod extensions_action_target_tests {
    ...
    fn skills_toggle_resolves_name_and_resulting_state() {
        let skill = ezer_tools::implementations::skills::types::SkillInfo {
            name: "my-skill".into(),
            enabled: false,
            ..Default::default()
        };
