...
impl AgentView {
    ...
    pub(crate) fn log_prompt_suggestion_shown_if_visible(&mut self) {
        ...
        ezer_telemetry::session_ctx::log_event(ezer_telemetry::events::PromptSuggestion {
            action: ezer_telemetry::events::PromptSuggestionAction::Shown,
            chars,
            words,
            model: None,
            latency_ms: None,
    ...
    pub(in crate::app) fn dismiss_matched_plugin(&mut self) {
        ...
        ezer_telemetry::session_ctx::log_event(
            ezer_telemetry::events::PluginCtaDismissed {
    ...
    pub(in crate::app) fn connect_matched_plugin(&mut self) {
        ...
        ezer_telemetry::session_ctx::log_event(
            ezer_telemetry::events::PluginCtaConnectClicked {
