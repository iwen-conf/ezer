...
pub struct BannerSlotParams<'a> {
    ...
    pub(crate) announcements: &'a [ezer_announcements::RemoteAnnouncement],
...
pub struct AgentView {
    ...
    pub context_state: Option<ezer_shell::session::ContextInfo>,
    pub status_context: Option<ezer_status_line::StatusLineContext>,
    ...
    pub(crate) pending_elicitation: Option<(
        ezer_tools::mcp_elicitation::McpElicitExtRequest,
    ...
    pub(crate) session_mode: ezer_tools::types::SessionMode,
    /// Optimistic Shift+Tab pick over `available_modes`, cleared like `plan_mode_pending`.
    pub(crate) session_mode_pending: Option<ezer_tools::types::SessionMode>,
    ...
    pub(crate) deferred_session_mode: Option<ezer_tools::types::SessionMode>,
    ...
    pub memory_mode: Option<ezer_shell::config::MemoryMode>,
        ...
        LocalQuestionKind::CreditLimitUpsell { choices } => {
            ...
            if id == Some(super::dispatch::CREDIT_LIMIT_RETRY_OPTION_ID) {
                ezer_telemetry::session_ctx::log_event(
                    ezer_telemetry::events::CreditLimitUpsellClicked {
                        surface:
                            ezer_telemetry::events::CreditLimitUpsellSurface::QuestionModal,
                        choice: ezer_telemetry::events::CreditLimitChoice::RetryLastPrompt,
                    },
                );
            ...
            let choice = choices
                .get(*idx)
                .copied()
                .unwrap_or(ezer_telemetry::events::CreditLimitChoice::PayAsYouGo);
            ezer_telemetry::session_ctx::log_event(
                ezer_telemetry::events::CreditLimitUpsellClicked {
                    surface: ezer_telemetry::events::CreditLimitUpsellSurface::QuestionModal,
                    choice,
                },
            );
