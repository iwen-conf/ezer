                ...
                if let Err(msg) = self.prompt.insert_image(pasted) {
                    ...
                    if ctx.source.tip_showing() {
                        ezer_telemetry::session_ctx::log_event(
                            ezer_telemetry::events::ContextualTip {
...
pub(super) mod paste_key_tests {
    ...
    -> crate::views::question_view::QuestionViewState {
        let question = ezer_tools::implementations::ezer_build::ask_user_question::Question {
            question: "Pick one?".to_string(),
            options: vec![
                ezer_tools::implementations::ezer_build::ask_user_question::QuestionOption {
                    label: "A".to_string(),
