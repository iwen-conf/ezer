    ...
    pub(in crate::app) fn handle_prompt_key(
            ...
            && self.prompt.prompt_suggestion_visible()
        {
            if key!(Tab).matches(key) || key!(Right).matches(key) {
                if self.prompt.accept_prompt_suggestion() {
                    ...
                    ezer_telemetry::session_ctx::log_event(
                        ezer_telemetry::events::PromptSuggestion {
                            action: ezer_telemetry::events::PromptSuggestionAction::Accepted,
                            chars,
                            words,
                            model: None,
                            latency_ms: None,
                ...
                && self.prompt.text().is_empty()
            {
                ...
                ezer_telemetry::session_ctx::log_event(
                    ezer_telemetry::events::PromptSuggestion {
                        action: ezer_telemetry::events::PromptSuggestionAction::Dismissed,
                        chars,
                        words,
                        model: None,
                        latency_ms: None,
