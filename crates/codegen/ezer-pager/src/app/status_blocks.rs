...
fn format_cost(m: &ezer_shell::extensions::notification::PromptUsageModel) -> String {
    use ezer_shell::extensions::notification::ticks_to_usd;
...
mod tests {
    use super::*;
    use ezer_shell::extensions::notification::{PromptUsage, PromptUsageModel};
