...
use ezer_shell::extensions::notification::GoalClassifierVerdict;
...
impl BgTaskState {
    ...
    pub fn tombstone_from_snapshot(
        snapshot: &ezer_tools::types::TaskSnapshot,
        status: BgTaskStatus,
...
impl AgentSession {
    ...
    pub fn local_session_dir(&self) -> Option<PathBuf> {
        Some(ezer_shell::session::persistence::session_dir(
    ...
    pub fn ensure_local_session_dir(&self) -> Option<std::io::Result<PathBuf>> {
        Some(
            ezer_shell::session::persistence::ensure_owner_only_session_dir(
                &self.local_session_info()?,
            ),
        )
    }
    fn local_session_info(&self) -> Option<ezer_shell::session::info::Info> {
        Some(ezer_shell::session::info::Info {
