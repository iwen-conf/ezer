...
use ezer_status_line::{ResolvedStatusLine, StatusLineConfig, StatusLineItem, StatusLineType};
...
impl StatusLineMetrics {
    ...
    pub(crate) fn report_config(&self, cfg: &StatusLineConfig) {
        ...
        ezer_telemetry::session_ctx::log_event(
            ezer_telemetry::events::StatusLineConfigured {
                kind,
    ...
    fn health_event(&self) -> Option<ezer_telemetry::events::StatusLineHealth> {
        ...
        Some(ezer_telemetry::events::StatusLineHealth {
            kind,
