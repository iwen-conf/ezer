...
pub(crate) fn is_server_initiated_prompt(prompt_id: &str) -> bool {
    ezer_shell::session::PromptOrigin::from_prompt_id(prompt_id).is_synthetic()
}
...
pub(crate) fn is_scheduler_fired_prompt(prompt_id: &str) -> bool {
    matches!(
        ezer_shell::session::PromptOrigin::from_prompt_id(prompt_id),
        ezer_shell::session::PromptOrigin::SchedulerFired
    )
}
...
pub(crate) fn is_wake_prompt(prompt_id: &str) -> bool {
    matches!(
        ezer_shell::session::PromptOrigin::from_prompt_id(prompt_id),
        ezer_shell::session::PromptOrigin::TaskCompleted { .. }
            | ezer_shell::session::PromptOrigin::SubagentCompleted { .. }
            | ezer_shell::session::PromptOrigin::WorkflowCompleted { .. }
            | ezer_shell::session::PromptOrigin::ParentAgentMessage { .. }
            | ezer_shell::session::PromptOrigin::ParentHumanMessage { .. }
            | ezer_shell::session::PromptOrigin::NotificationDrain
    )
}
