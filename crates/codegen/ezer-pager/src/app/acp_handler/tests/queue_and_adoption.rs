#![cfg_attr(rustfmt, rustfmt::skip)]
    ...
    fn queue_changed_adopts_running_prompt_id_only_when_unset() {
        ...
        let shell_payload = ezer_shell::session::prompt_queue::QueueChanged {
    ...
    fn bash_kind_round_trips_and_adoption_sets_bash_turn() {
        ...
        let shell = ezer_shell::session::prompt_queue::QueueChanged {
            session_id: "sess-1".to_string(),
            entries: vec![ezer_shell::session::prompt_queue::QueueEntryWire {
                id: "b1".to_string(),
                version: 0,
                owner: None,
                last_editor: None,
    ...
    fn bind_session_id_resets_cursor_only_on_id_change() {
        ...
        agent.deferred_subagent_finishes.defer(
            ...
            lifecycle,
            ezer_shell::extensions::notification::SessionNotification {
