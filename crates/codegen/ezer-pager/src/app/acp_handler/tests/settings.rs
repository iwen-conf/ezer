#![cfg_attr(rustfmt, rustfmt::skip)]
    ...
    /// The settings path must not touch announcements: the shell already emits generation-ordered `ezer/announcements/update` for every settings writer.
