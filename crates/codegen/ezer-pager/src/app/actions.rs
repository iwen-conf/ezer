...
use ezer_shell::session::unified_list::SessionKind;
...
pub enum SwitchModelError {
    ...
    IncompatibleAgent {
        error: ezer_shell::agent::config::ModelSwitchIncompatibleAgentError,
...
pub enum Action {
    ...
    OpenExtensionsModal {
        ...
        trigger: ezer_telemetry::events::ExtensionsModalTrigger,
    },
    ...
    AnnouncementsOpenCta(ezer_telemetry::events::AnnouncementCtaSurface),
...
pub struct DraftFeedbackBody {
    pub draft_id: ezer_feedback::FeedbackDraftId,
    pub title: String,
    pub details: String,
    pub area: Option<String>,
    pub r#type: ezer_feedback::FeedbackType,
    pub task_category: Option<ezer_feedback::FeedbackTaskCategory>,
    pub failure_mode: Option<ezer_feedback::FeedbackFailureMode>,
    pub images: Vec<ezer_shell::session::FeedbackImage>,
}
...
pub enum Effect {
    ...
    PersistFeatureOverride {
        feature: ezer_shell::agent::config::Feature,
        saved: Option<bool>,
    },
    ...
    SendFeedback {
        ...
        images: Vec<ezer_shell::session::FeedbackImage>,
    ...
    /// `ezer/auth/hydrate_team_capability` for `identity`; the answer is dropped if the account changed meanwhile.
...
pub enum WorkspaceMutation {
    Upsert(Vec<ezer_dashboard_store::NewMember>),
    Remove(Vec<ezer_dashboard_store::MemberKey>),
    Layout(ezer_dashboard_store::LayoutPatch),
}
#[derive(Debug)]
pub struct WorkspaceMutationFailure {
    pub key: ezer_dashboard_store::MemberKey,
    pub error: String,
    pub retryable: bool,
}
#[derive(Debug)]
pub enum WorkspaceWriteCompletion {
    Upsert {
        members: Vec<ezer_dashboard_store::NewMember>,
        snapshot: Result<ezer_dashboard_store::WorkspaceSnapshot, String>,
        failures: Vec<WorkspaceMutationFailure>,
    },
    Remove {
        keys: Vec<ezer_dashboard_store::MemberKey>,
        snapshot: Result<ezer_dashboard_store::WorkspaceSnapshot, String>,
        failures: Vec<WorkspaceMutationFailure>,
    },
    Layout {
        patch: ezer_dashboard_store::LayoutPatch,
        outcome: ezer_dashboard_store::LayoutApplyOutcome,
    },
}
#[derive(Debug)]
#[allow(clippy::large_enum_variant)]
pub enum TaskResult {
    ...
    ForeignResumeHintDetected {
        canonical_cwd: std::path::PathBuf,
        launch_token: u64,
        hint: Option<ezer_foreign_sessions::RecentForeignSession>,
    },
    ...
    WorkspaceSnapshotLoaded {
        store: ezer_dashboard_store::WorkspaceStore,
        snapshot: ezer_dashboard_store::WorkspaceSnapshot,
    },
    ...
    WorkspaceRefreshed {
        store: ezer_dashboard_store::WorkspaceStore,
        snapshot: Result<Option<ezer_dashboard_store::WorkspaceSnapshot>, String>,
    },
    ...
    BgTaskKilled {
        session_id: String,
        task_id: String,
        outcome: Option<ezer_tools::types::KillOutcome>,
    },
    ...
    ChangelogFetched {
        ...
        entries: Vec<ezer_shell::util::changelog::ChangelogEntry>,
    },
    ...
    MemoryListLoaded {
        agent_id: AgentId,
        result: Result<ezer_shell::extensions::memory::MemoryListing, String>,
    },
    /// Shell answered a memory on/off request.
    MemoryToggleResult {
        agent_id: AgentId,
        result: Result<ezer_shell::extensions::memory::MemoryToggleResponse, String>,
    },
    /// Shell answered a `/memory` modal delete request.
    MemoryForgetResult {
        agent_id: AgentId,
        path: String,
        result: Result<ezer_shell::extensions::memory::MemoryForgetResponse, String>,
    },
    /// `/flush` finished.
    MemoryFlushComplete {
        agent_id: AgentId,
        result: Result<ezer_shell::extensions::memory::MemoryFlushResponse, String>,
    },
    /// `/dream` finished.
    MemoryDreamComplete {
        agent_id: AgentId,
        result: Result<ezer_shell::extensions::memory::MemoryDreamResponse, String>,
    },
    ...
    SkillsListLoaded {
        agent_id: AgentId,
        result: Result<Vec<ezer_tools::implementations::skills::types::SkillInfo>, String>,
    },
    WorkflowsListLoaded {
        agent_id: AgentId,
        session_id: acp::SessionId,
    ...
    SessionInfoComplete {
        agent_id: AgentId,
        session_id: acp::SessionId,
        info: Box<ezer_shell::session::SessionInfoResponse>,
    ...
    SessionUsageComplete {
        agent_id: AgentId,
        session_id: acp::SessionId,
        usage: Box<ezer_shell::extensions::notification::PromptUsage>,
        nonce: u64,
    },
    ...
    FeedbackComplete {
        agent_id: AgentId,
        origin: FeedbackSendOrigin,
        outcome: ezer_shell::session::FeedbackOutcome,
    ...
    FeedbackDraftListComplete {
        ...
        modal_id: crate::views::feedback_modal::FeedbackModalId,
        generation: u64,
        result: Result<Vec<ezer_feedback::FeedbackDraft>, String>,
    },
    FeedbackDraftLoadComplete {
        agent_id: AgentId,
        load: crate::views::feedback_modal::FeedbackDraftLoad,
        result: Result<ezer_feedback::FeedbackDraft, String>,
    },
    ...
    GateRefreshed {
        settings: Option<ezer_shell::util::config::RemoteSettings>,
    },
