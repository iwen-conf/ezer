...
impl AppView {
    ...
    #[must_use]
    pub fn impose_gate(&mut self, gate: ezer_login::GateInfo) -> Vec<Effect> {
    ...
    #[must_use]
    fn defer_gate_for_verification(&mut self, gate: ezer_login::GateInfo) -> Vec<Effect> {
...
mod tests {
    ...
    fn watch_gate() -> ezer_login::GateInfo {
        ezer_login::GateInfo {
    ...
    fn may_be_free_tier_matrix() {
        ...
        app.subscription_tier = Some("highest tier".into());
        assert!(!app.may_be_free_tier());
    ...
    fn fire_subscription_check_guards_and_debounces() {
        ...
        paid.subscription_tier = Some("MaxTier".into());
        assert!(
    ...
    fn impose_gate_direct_for_non_consumer_and_already_gated() {
        ...
        let new_copy = ezer_login::GateInfo {
