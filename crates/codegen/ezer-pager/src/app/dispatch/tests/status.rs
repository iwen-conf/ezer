...
fn recheck_keeps_hydrated_capability_only_for_the_same_account() {
    let team = ezer_login::AuthMeta {
        email: Some("a@acme.test".into()),
        team_id: Some("team-a".into()),
        is_team_principal: true,
        ..ezer_login::AuthMeta::default()
    };
    let personal = ezer_login::AuthMeta {
...
fn context_info_response() -> ezer_shell::session::SessionInfoResponse {
