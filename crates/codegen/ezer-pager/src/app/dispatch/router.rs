...
use super::billing::dispatch_open_upgrade_url;
use super::ctx::{
    ...
    let effects = match action {
        ...
        Action::AnnouncementsOpenCta(surface) => {
            if let Some((promo, url)) = crate::views::announcements::promo_cta_target(
                ...
                log_event(ezer_telemetry::events::AnnouncementCtaClicked {
                    id: promo_id,
                    source: surface,
                });
        ...
        Action::SetCodingDataSharing { opted_in } => set_coding_data_sharing(
            app,
            opted_in,
            ezer_telemetry::events::CodingDataConsentSource::Settings,
        ),
        ...
        Action::OpenUpgradeUrl => dispatch_open_upgrade_url(app),
