...
use ezer_shell::extensions::notification::MemoryDisabledReason;
...
pub fn build_entries(
    files: Vec<ezer_shell::extensions::notification::MemoryFileInfo>,
) -> Vec<MemoryFileEntry> {
...
fn entry_label(f: &ezer_shell::extensions::notification::MemoryFileInfo) -> String {
...
mod tests {
    ...
    fn observation_labels_prefer_title_then_readable_key() {
        use ezer_shell::extensions::notification::MemoryFileInfo;
    ...
    fn confirmed_delete_sends_forget_and_applies_reply() {
        ...
        state.apply_forget_result(
            ...
            Ok(MemoryForgetResponse::Rejected {
                reason: ezer_shell::extensions::memory::MemoryForgetRejection::DreamRunning,
    ...
    fn empty_enabled_state_renders_onboarding_copy() {
        ...
        let manifest = |scope: &str| ezer_shell::extensions::notification::MemoryFileInfo {
        ...
        let mut with_topic = MemoryModalState::new(build_entries(vec![
            manifest("global"),
            manifest("workspace"),
            ezer_shell::extensions::notification::MemoryFileInfo {
