...
use ezer_shell::session::persistence::MAX_TITLE_SCALARS as MAX_RENAME_SCALARS;
...
pub struct PendingDispatchModel {
    ...
    pub effort: Option<ezer_shell::sampling::types::ReasoningEffort>,
    pub display: String,
}
...
impl DashboardState {
    ...
    pub fn new() -> Self {
        ...
        Self {
            ...
            preview_enabled: ezer_shell::agent::config::UiConfig::default()
    ...
    fn handle_mouse(&mut self, mouse: &crossterm::event::MouseEvent) -> InputOutcome {
        ...
        if matches!(mouse.kind, MouseEventKind::Down(MouseButton::Left)) {
            ...
            if self.upgrade_cta_hit.contains(mouse.column, mouse.row) {
                return InputOutcome::Action(Action::AnnouncementsOpenCta(
                    ezer_telemetry::events::AnnouncementCtaSurface::Dashboard,
                ));
            }
