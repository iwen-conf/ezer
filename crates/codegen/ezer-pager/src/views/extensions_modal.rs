...
use ezer_tools::implementations::skills::types::SkillInfo;
...
fn is_official_marketplace_source(source: &xai_hooks_plugins_types::MarketplaceScanResult) -> bool {
    source.source_name == ezer_plugin_marketplace::OFFICIAL_SOURCE_NAME
        || ezer_plugin_marketplace::is_official_source_url(&source.source_url_or_path)
}
...
impl ExtensionsTab {
    ...
    pub fn telemetry_tab(self) -> ezer_telemetry::events::ExtensionsModalTab {
        use ezer_telemetry::events::ExtensionsModalTab;
        match self {
...
fn skill_source_str(skill: &SkillInfo) -> String {
    if let Some(ref cs) = skill.config_source {
        match cs {
            ...
            ezer_tools::types::config_source::ConfigSource::Project { path } => {
            ...
            ezer_tools::types::config_source::ConfigSource::Plugin { plugin_name, .. } => {
...
mod tests {
    ...
    fn make_skill(
        ...
        ezer_tools::implementations::skills::types::SkillInfo {
            ...
            metadata: None,
            path: "test".to_string(),
            scope: ezer_tools::implementations::skills::types::SkillScope::User,
            config_source: None,
            plugin_name: None,
            plugin_version: None,
            plugin_root: None,
    ...
    fn make_plugin_skill(
        ...
        skill.scope = ezer_tools::implementations::skills::types::SkillScope::Plugin;
        skill.config_source = Some(ezer_tools::types::config_source::ConfigSource::Plugin {
    ...
    fn mcp_add_url_derives_name() {
        ...
        match action {
            Some(ButtonAction::AddMcpServer { name, config }) => {
                ...
                assert!(matches!(
                    config.transport,
                    ezer_shell::util::config::McpServerTransportConfig::StreamableHttp { .. }
                ));
            }
        ...
        match action {
            Some(ButtonAction::AddMcpServer { name, config }) => {
                ...
                match config.transport {
                    ezer_shell::util::config::McpServerTransportConfig::Stdio {
                        command,
                        args,
                        ..
                    } => {
    ...
    fn skills_groups_then_az_by_label() {
        ...
        project_z.scope = ezer_tools::implementations::skills::types::SkillScope::Local;
        project_z.config_source = Some(
            ezer_tools::types::config_source::ConfigSource::Project {
        ...
        project_a.scope = ezer_tools::implementations::skills::types::SkillScope::Repo;
