...
struct WelcomeLayoutInput<'a> {
    ...
    prompt_compact: bool,
    announcement: Option<&'a ezer_announcements::RemoteAnnouncement>,
...
pub(super) fn render_version_badge(
    ...
    let channel = ezer_update::channel_label();
    match &mode {
        VersionBadgeMode::Full { .. } => {
            ...
            spans.push(Span::styled(
                format!("{}{}", ezer_version::VERSION, channel),
                Style::default().fg(theme.gray),
            ));
        }
...
pub struct WelcomeRenderParams<'a> {
    ...
    pub announcement: Option<&'a ezer_announcements::RemoteAnnouncement>,
    ...
    pub foreign_resume_hint: Option<&'a ezer_foreign_sessions::RecentForeignSession>,
    pub is_api_key_auth: bool,
    pub session_picker_content_results:
        Option<&'a [ezer_shell::extensions::session_search::SearchSessionHit]>,
    ...
    pub gate: Option<&'a ezer_login::GateInfo>,
...
fn render_announcement_section(
    ...
    buf: &mut Buffer,
    theme: &Theme,
    announcement: &ezer_announcements::RemoteAnnouncement,
    min_width_hint: u16,
    content_height: u16,
    expanded: bool,
    mouse_pos: Option<(u16, u16)>,
...
mod tests {
    ...
    fn foreign_resume_tip_names_each_tool_and_age() {
        ...
        for (tool, label) in [
            ...
            let hint = ezer_foreign_sessions::RecentForeignSession {
                tool,
    ...
    fn long_ann() -> ezer_announcements::RemoteAnnouncement {
...
the usual channels. "
    ...
    fn announcement_equal_for_short_message() {
        let area = Rect::new(0, 0, 120, 60);
        let a = ezer_announcements::RemoteAnnouncement {
            title: Some("FYI".into()),
