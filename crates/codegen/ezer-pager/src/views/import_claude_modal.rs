...
use ezer_shell::claude_import::{ImportPlan, ImportableItem, PathKind, find_project_root};
...
mod tests {
    use super::*;
    use ezer_shell::claude_import::PathKind;
    use ezer_workspace::permission::types::{PatternMode, PermissionRule, ToolFilter};
    ...
    fn filtered_plan_respects_per_item_selection_after_grouping() {
        use ezer_shell::claude_import::ImportableItem;
