...
//! This module detects those blocks in an agent message via the generic [`CodeBlockSpan`](ezer_markdown::CodeBlockSpan) API.
...
use ezer_markdown::MarkdownRenderView;
...
pub struct MermaidBlock {
    ...
    /// Taken from [`CodeBlockSpan::body`](ezer_markdown::CodeBlockSpan::body).
    ...
    /// Mirrors [`CodeBlockSpan::output_line_range`](ezer_markdown::CodeBlockSpan::output_line_range).
...
) -> impl Iterator<Item = &'a ezer_markdown::CodeBlockSpan> {
    view.code_blocks
        .iter()
