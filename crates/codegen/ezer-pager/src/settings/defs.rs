...
use ezer_shell::agent::config::{Feature, UiConfig};
    ...
    vec![
        ...
        SettingMeta {
            ...
            kind: SettingKind::Bool {
                ...
                default: ezer_shell::util::config::DEFAULT_REMEMBER_TOOL_APPROVALS,
            },
            restart_required: true,
            hidden_in_minimal: false,
        },
        ...
        SettingMeta {
            ...
            description: "On: ezer cannot set models for subagents\n\
                          Off: ezer may choose a different model for a subagent. Takes effect \
                          after restart.\n\
