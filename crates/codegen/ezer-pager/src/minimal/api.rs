//! Everything the `ezer-pager-minimal` crate reads and renders through.
//!
...
/// loop renders a time-budgeted slice per frame (`ezer-pager-minimal::full_view::pump_transcript`).
