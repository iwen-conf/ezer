...
Terminal UI (TUI) for ezer. Provides the interactive full-screen interface
...
- [Hook Examples](../ezer-hooks/examples/README.md) — sample hooks for common workflows
- [Hooks Crate (`ezer-hooks`)](../ezer-hooks/) — hook runtime, event types, and execution engine
- [Plugin Marketplace Crate (`ezer-plugin-marketplace`)](../ezer-plugin-marketplace/) — marketplace source loading, scanning, and install
