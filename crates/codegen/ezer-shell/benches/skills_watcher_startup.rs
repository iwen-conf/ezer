...
//!
//! ```text
//! cargo bench -p ezer-shell --bench skills_watcher_startup
//! # optional scale:
//! EZER_SKILLS_WATCHER_BENCH_DIRS=12000 cargo bench -p ezer-shell --bench skills_watcher_startup
//! ```
//!
...
use ezer_shell::config::watcher::SkillsFileWatcher;
