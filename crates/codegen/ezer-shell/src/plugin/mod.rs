...
pub(crate) mod test_fixtures {
    ...
    use ezer_plugin_marketplace::{MarketplaceSource, SourceKind};
    ...
    pub(crate) fn marketplace_allowlist(
        urls: &[&str],
    ) -> ezer_workspace::permission::resolution::MarketplacePolicy {
        ezer_workspace::permission::resolution::MarketplacePolicy::single(
            ezer_workspace::permission::resolution::MarketplaceAllowlist {
                allowed_urls: urls.iter().map(|u| u.to_string()).collect(),
                source_path: None,
                authority:
                    ezer_workspace::permission::resolution::PolicySourceAuthority::Native,
            },
        )
    }
}
