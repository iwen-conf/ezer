...
fn spawn_ctx(parent_cwd: PathBuf) -> SubagentSpawnContext {
    ...
    SubagentSpawnContext {
        ...
        sampling_config: ezer_sampler::SamplerConfig {
        ...
        fs: Arc::new(ezer_workspace::file_system::LocalFs::new(
            PathBuf::from("/tmp"),
        )),
        ...
        parent_skills: None,
        parent_skills_config: ezer_agent::prompt::skills::SkillsConfig::default(),
        parent_compat: ezer_tools::types::compat::CompatConfig::default(),
        parent_paths_config: Default::default(),
        synthetic_trace_tx: None,
        task_output_tool_name: ezer_tools::reminders::task_completion::DEFAULT_TASK_OUTPUT_TOOL
            .to_string(),
