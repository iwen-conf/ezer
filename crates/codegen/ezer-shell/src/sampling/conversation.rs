//! Conversation types: re-exports the canonical set from `ezer_sampling_types` plus ezer-shell-specific additions.

use std::collections::HashSet;

pub use ezer_sampling_types::conversation::*;
...
/// Lives in ezer-shell because it references shell-internal config and upload types.
#[derive(Debug, Clone)]
...
/// Keep the "complete turn" definition in sync with `count_complete_turns` in `ezer-subagent-resolution/src/context.rs`.
