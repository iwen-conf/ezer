...
//! Tool execution goes through the ToolBridge, which has its own SessionContext from ezer-tools.
...
use ezer_workspace::file_system::{AsyncFileSystem, AsyncFsWrapper};
use ezer_workspace::session::file_state::FileStateHandle;
...
pub struct ToolContext {
    ...
    pub task_wake_suppressed:
        Option<ezer_tools::reminders::task_completion::TaskWakeSuppressed>,
