//! The canonical implementation now lives in `ezer_tools::retry`.
//! This module re-exports with backward-compatible aliases.

pub use ezer_tools::retry::BackoffConfig as RetryConfig;
pub use ezer_tools::retry::{BackoffConfig, execute_with_backoff};
