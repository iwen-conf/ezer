...
pub(crate) fn log_memory_injection(
    ...
    ezer_telemetry::session_ctx::log_event(MemoryInjection {
        session_id,
        outcome,
...
impl MemoryObservationSink for TelemetryMemoryObservationSink {
    fn observe_search(&self, observation: MemorySearchObservation) {
        ezer_telemetry::session_ctx::log_event(MemorySearch {
            ...
            outcome: match observation.outcome {
                ezer_memory::MemorySearchOutcome::Results => TelemetryOutcome::Results,
                ezer_memory::MemorySearchOutcome::Empty => TelemetryOutcome::Empty,
                ezer_memory::MemorySearchOutcome::Error => TelemetryOutcome::Error,
            },
    ...
    fn observe_watcher_sync(&self, observation: MemoryWatcherSyncObservation) {
        ezer_telemetry::session_ctx::log_event(MemoryWatcherSync {
            session_id: self.session_id.clone(),
