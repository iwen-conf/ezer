...
use ezer_tools::implementations::use_tool::InlineMcpInvocation;
use ezer_tools::types::tool_io::ToolInput;
...
fn string_root_schema_is_not_stringified() {
    ...
    let toolset = ezer_tools::registry::types::FinalizedToolset::empty_for_test();
