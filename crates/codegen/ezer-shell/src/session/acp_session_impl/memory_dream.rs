...
use super::*;
use ezer_telemetry::session_end::{self, Phase};
...
impl SessionActor {
    ...
    pub(super) async fn register_memory_tools(
        &self,
        bridge: &ezer_tools::bridge::ToolBridge,
    ) -> Result<(), String> {
        ...
        bridge
            .register_mcp_tools(
                ...
                ezer_tools::implementations::memory::search_tool::MemorySearchImpl,
                None,
            )
        ...
        bridge
            .register_mcp_tools(
                ...
                ezer_tools::implementations::memory::get_tool::MemoryGetImpl,
                None,
            )
    ...
    pub(super) fn emit_memory_session_summary(
        ...
        ezer_telemetry::session_ctx::log_event(
            ezer_telemetry::memory_telemetry::MemorySessionSummary {
                ...
                memory_mode: match self.memory.mode() {
                    Some(crate::config::MemoryMode::V2) => {
                        ezer_telemetry::memory_telemetry::MemoryMode::V2
                    }
                    Some(crate::config::MemoryMode::Legacy) | None => {
                        ezer_telemetry::memory_telemetry::MemoryMode::Legacy
                    }
                },
    ...
    pub(super) async fn run_session_end_memory_pipeline(
        &self,
        log_suffix: &str,
        timer: &ezer_telemetry::session_end::SharedSessionEndTimer,
    ) {
    ...
    pub(super) async fn run_memory_flush(
        ...
        tracing::info!(target: ezer_telemetry::memory_log::TARGET, "MEMORY_FLUSH: starting");
        ...
        let result = async {
            ...
            ezer_telemetry::session_ctx::log_event(
                ezer_telemetry::memory_telemetry::MemoryFlushStart {
                    session_id: self.session_info.id.to_string(),
        ...
        tracing::info!(target: ezer_telemetry::memory_log::TARGET, outcome = %outcome, "MEMORY_FLUSH: completed");
        ...
        ezer_telemetry::session_ctx::log_event(
            ezer_telemetry::memory_telemetry::MemoryFlushComplete {
                session_id: self.session_info.id.to_string(),
                trigger: trigger.to_owned(),
        ...
        let flush_trigger = match trigger {
            "slash_command" => ezer_telemetry::events::MemoryFlushTrigger::SlashCommand,
            "interval" => ezer_telemetry::events::MemoryFlushTrigger::Interval,
            "pre_compaction" => ezer_telemetry::events::MemoryFlushTrigger::PreCompaction,
            _ => ezer_telemetry::events::MemoryFlushTrigger::UserRequested,
        };
        ezer_telemetry::session_ctx::log_event(ezer_telemetry::events::MemoryFlushed {
