...
impl SessionActor {
        ...
        match &notification.update {
            XaiSessionUpdate::SubagentSpawned {
                ...
                let envelope = self.fire_hook(
                    ezer_hooks::event::HookEventName::SubagentStart,
                    None,
                    ezer_hooks::event::HookPayload::SubagentStart {
                ...
                if let Some(registry) = hook_registry_snapshot {
                    ...
                    let _ = ezer_hooks::dispatcher::dispatch_non_blocking(
                        &registry,
                        ezer_hooks::event::HookEventName::SubagentStart,
                        &envelope,
                        &ctx,
    ...
    pub(super) async fn dispatch_notification_hook(
        ...
        let envelope = self.fire_hook(
            ezer_hooks::event::HookEventName::Notification,
            None,
            ezer_hooks::event::HookPayload::Notification {
