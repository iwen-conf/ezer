...
impl From<&ezer_sampling_types::TokenUsage> for PromptCacheUsage {
    fn from(usage: &ezer_sampling_types::TokenUsage) -> Self {
...
pub(crate) struct AuxCall {
    ...
    pub(crate) hosted_tools: Vec<ezer_sampling_types::HostedTool>,
    pub(crate) model: String,
    /// Must match the main turn's, or the prompt differs before the conversation history even starts.
    pub(crate) reasoning_effort: Option<ezer_sampling_types::ReasoningEffort>,
...
pub(crate) struct SideCallSetup {
    pub(crate) client: ezer_sampler::SamplingClient,
...
impl SessionActor {
    ...
    pub(crate) fn parent_cached_request(&self, call: AuxCall) -> ConversationRequest {
        ...
        ConversationRequest {
            ...
            length_policy: ezer_sampling_types::LengthPolicy::Fail,
            ..Default::default()
        }
    }
