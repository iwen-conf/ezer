...
impl ezer_login::refresh::TokenRefresher for WakeGapRefresher {
    async fn refresh(
        &self,
        reason: ezer_login::refresh::RefreshReason,
    ) -> ezer_login::refresh::RefreshOutcome {
        self.calls.fetch_add(1, Ordering::SeqCst);
        if self.fail_pre_request && reason == ezer_login::refresh::RefreshReason::PreRequest {
            return ezer_login::refresh::RefreshOutcome::TransientFailure {
...
#[async_trait::async_trait]
impl ezer_login::refresh::TokenRefresher for DeferredRefreshNeverLands {
    async fn refresh(
        &self,
        reason: ezer_login::refresh::RefreshReason,
    ) -> ezer_login::refresh::RefreshOutcome {
        match reason {
            ezer_login::refresh::RefreshReason::ServerRejected => {
                self.server_rejected_calls.fetch_add(1, Ordering::SeqCst);
            }
            ezer_login::refresh::RefreshReason::PreRequest => {
...
#[async_trait::async_trait]
impl ezer_login::refresh::TokenRefresher for DeferredThenRecovers {
    async fn refresh(
        &self,
        reason: ezer_login::refresh::RefreshReason,
    ) -> ezer_login::refresh::RefreshOutcome {
        if reason == ezer_login::refresh::RefreshReason::ServerRejected {
            self.server_rejected_calls.fetch_add(1, Ordering::SeqCst);
        }
