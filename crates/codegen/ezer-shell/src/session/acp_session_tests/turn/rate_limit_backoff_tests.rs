...
pub(super) fn sampler_surfaces_429() -> ezer_sampler::RetryPolicy {
    ezer_sampler::RetryPolicy {
        max_retries: 5,
        rate_limit_retry_threshold: ezer_sampler::RATE_LIMIT_RETRY_DISABLED,
        ..Default::default()
    }
}

fn sampler_retries_429() -> ezer_sampler::RetryPolicy {
    ezer_sampler::RetryPolicy {
        max_retries: 5,
        rate_limit_retry_threshold: ezer_sampler::RATE_LIMIT_RETRY_THRESHOLD,
        ..Default::default()
    }
}
...
pub(super) async fn actor_under_test(
    ...
    session: SessionKind,
    retry_policy: ezer_sampler::RetryPolicy,
    ...
    let sampler_handle =
        ezer_sampler::SamplerActor::spawn(sampling_cfg, retry_policy, sampler_event_tx);
