use super::support::*;
use super::*;
use ezer_tools::reminders::task_completion::consumed_completion_ids;
use ezer_tools::types::output::{BashOutput, TextOutput, ToolOutput};
use xai_tool_types::{
...
fn wake_body(subagent_id: &str) -> String {
    ezer_tools::reminders::wrap_reminder(
        &ezer_tools::reminders::task_completion::format_subagent_completion(
...
async fn genuine_user_start_consumes_deferred_completions_without_notification_turn() {
    ...
    local
        .run_until(async {
            ...
            let body = ezer_tools::reminders::task_completion::format_monitor_completion(
                &ezer_tools::types::TaskSnapshot {
                    ...
                    signal: None,
                    completed: true,
                    kind: ezer_tools::computer::types::TaskKind::Monitor,
                    block_waited: false,
...
struct OneTaskTerminal {
    tasks: Vec<ezer_tools::computer::types::TaskSnapshot>,
}
#[async_trait::async_trait]
impl ezer_tools::computer::types::TerminalBackend for OneTaskTerminal {
    async fn run(
        &self,
        _: ezer_tools::computer::types::TerminalRunRequest,
    ) -> Result<
    ...
    async fn get_task(&self, _: &str) -> Option<ezer_tools::computer::types::TaskSnapshot> {
        None
    }
    async fn kill_task(&self, _: &str) -> ezer_tools::computer::types::KillOutcome {
        ezer_tools::computer::types::KillOutcome::NotFound
    }
...
fn completed_bash_task(id: &str) -> ezer_tools::computer::types::TaskSnapshot {
    ezer_tools::computer::types::TaskSnapshot {
        task_id: id.into(),
