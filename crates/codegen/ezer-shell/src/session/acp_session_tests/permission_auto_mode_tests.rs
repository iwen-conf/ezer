        ...
        .run_until(async {
            ...
            let d = session
                ...
                .request(PermissionRequest::new(
                    AccessKind::Bash("cargo test -p ezer-workspace".into()),
                    dummy_update,
                ))
                .await
                .decision;
            assert!(
                matches!(d, ezer_workspace::permission::Decision::Allow),
            ...
            let d2 = session
                ...
                .decision;
            assert!(
                !matches!(d2, ezer_workspace::permission::Decision::Allow),
    ...
    local
        .run_until(async {
            ...
            actor.permissions.set_classifier_transcript(vec![
                ezer_workspace::permission::ClassifierTurn::UserText("please run tests".into()),
            ]);
...
fn build_classifier_turns_captures_tool_use_excludes_text_and_results() {
    use ezer_workspace::permission::ClassifierTurn;
    let conv = vec![
        ...
        super::ConversationItem::assistant_tool_calls(vec![
            ezer_sampling_types::conversation::ToolCall {
...
fn build_classifier_turns_projects_full_filtered_resident_prefix() {
    use ezer_sampling_types::synthesized_reasoning_item;
    use ezer_workspace::permission::ClassifierTurn;
...
fn build_classifier_turns_filters_non_user_carriers() {
    use ezer_sampling_types::{ContentPart, SyntheticReason};
    use ezer_workspace::permission::ClassifierTurn;
    ...
    let conv = vec![
        ...
        tool_image,
        user_image,
        super::ConversationItem::User(ezer_sampling_types::UserItem {
