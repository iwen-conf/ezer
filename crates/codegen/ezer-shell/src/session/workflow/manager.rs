...
static WORKFLOW_RUNS_ACTIVE: ezer_telemetry::activity::ActivityGauge =
    ezer_telemetry::activity::ActivityGauge::work(
        ezer_telemetry::activity::WORKFLOW_RUNS_ACTIVE_KEY,
    );
            ...
            if !epoch_matches {
                ...
                log_run_ended(
                    RunEndMetadata {
                        ...
                        status: ezer_telemetry::events::WorkflowRunEndStatus::Superseded,
                        duration_ms: elapsed,
                        agents_used,
                        agent_budget,
                    },
            ...
            if state.is_none() {
                ...
                log_run_ended(
                    RunEndMetadata {
                        run_id: &watcher_run_id,
                        parent_session_id: &watcher_session_id,
                        status: ezer_telemetry::events::WorkflowRunEndStatus::Interrupted,
                        duration_ms: 0,
                        agents_used: 0,
                        agent_budget: None,
                    },
...
fn log_run_started(
    ...
    use ezer_telemetry::events::{WorkflowRunStarted, WorkflowSourceKind};
    ezer_telemetry::session_ctx::log_event(WorkflowRunStarted {
...
struct RunEndMetadata<'a> {
    ...
    status: ezer_telemetry::events::WorkflowRunEndStatus,
    duration_ms: u64,
    agents_used: u64,
...
fn log_run_ended(episode: RunEndMetadata<'_>, stats: &super::host_service::WorkflowAgentStats) {
    ezer_telemetry::session_ctx::log_event(ezer_telemetry::events::WorkflowRunEnded {
...
) -> ezer_telemetry::events::WorkflowRunEndStatus {
    use crate::session::workflow::tracker::WorkflowRunStatus as S;
    use ezer_telemetry::events::WorkflowRunEndStatus as E;
    match status {
        S::Active => E::Active,
