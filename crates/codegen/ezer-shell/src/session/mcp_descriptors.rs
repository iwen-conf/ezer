...
/// Uses the sanitizer shared with `ezer-mcp` so the advertised folder matches disk.
...
mod tests {
    ...
    fn server_dir_is_joined_under_root() {
        let root = Path::new("/home/u/.ezer/projects/enc/mcps");
