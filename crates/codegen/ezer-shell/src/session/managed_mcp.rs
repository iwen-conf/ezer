...
//!
//! The gateway catalog/call core lives in `ezer_shell_session_support::managed_mcp`.
//! It is re-exported here so `crate::session::managed_mcp::…` paths keep resolving unchanged.

pub use ezer_shell_session_support::managed_mcp::*;
...
pub(crate) fn merge_managed_mcp_servers_with_policy(
    ...
    merge_managed_mcp_servers_with_policy_from(
        ...
        plugin_registry,
        compat,
        ezer_workspace::permission::resolution::managed_settings(),
    )
}
...
pub(crate) fn mcp_subject(
    ...
    source: &ezer_tools::types::config_source::ConfigSource,
...
pub(crate) struct McpDiscoveryInputs<'a> {
    ...
    pub plugin_registry: Option<&'a ezer_agent::plugins::PluginRegistry>,
    pub compat: &'a ezer_tools::types::compat::CompatConfig,
}
...
fn load_plugin_mcp_servers_from_value(
    ...
    let normalized = ezer_agent::plugins::manifest::normalize_inline_mcp_servers(root);
...
fn load_plugin_mcp_servers_from_config(
    ...
    let sub = |s: &str| -> String {
        let s = ezer_agent::plugins::manifest::substitute_env_vars(s, plugin_root, plugin_data);
...
mod tests {
    ...
    fn settings_with_policy(
        policy: ezer_workspace::permission::resolution::McpServerPolicy,
    ) -> ezer_workspace::permission::resolution::ManagedSettings {
    ...
    fn client_provided_servers_survive_merge() {
        ...
        let cwd = empty_cwd();
        let compat = ezer_tools::types::compat::CompatConfig::default();
    ...
    fn client_cursor_server_dropped_when_cursor_mcps_disabled() {
        ...
        let mut compat = ezer_tools::types::compat::CompatConfig::default();
...
"#,
    ...
    fn plugin_registry_with_inline_server(
        ...
        use ezer_agent::plugins::discovery::{DiscoveredPlugin, PluginId};
        use ezer_agent::plugins::manifest::{PathOrInline, PluginManifest};
        use ezer_agent::plugins::{PluginRegistry, PluginScope};
...
"#,
    ...
    fn plugin_server_deduped_across_file_and_inline() {
        ...
        use ezer_agent::plugins::PluginScope;
        use ezer_agent::plugins::discovery::{DiscoveredPlugin, PluginId};
        use ezer_agent::plugins::manifest::{PathOrInline, PluginManifest};
    ...
    fn collect_plugin_oauth_configs_reads_byo_client_id_from_mcp_json() {
        ...
        use ezer_agent::plugins::PluginScope;
        use ezer_agent::plugins::discovery::{DiscoveredPlugin, PluginId};
        use ezer_agent::plugins::manifest::PluginManifest;
