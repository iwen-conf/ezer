...
fn verifier_template_renders_per_agent_type_and_falls_back() {
    ...
    tool_names.insert(
        ezer_tools::types::tool::ToolKind::ListDir,
        "cursor_ls".to_string(),
    );
    tool_names.insert(
        ezer_tools::types::tool::ToolKind::Search,
    ...
    let ezer = RoleToolNames::from_summary(&summary_with(&[
        (ezer_tools::types::tool::ToolKind::Read, "read_file"),
        (ezer_tools::types::tool::ToolKind::ListDir, "list_dir"),
        (ezer_tools::types::tool::ToolKind::Search, "grep"),
    ]))
...
fn cold_and_resume_renders_are_symmetric_for_an_index() {
    let summary = summary_with(&[
        (ezer_tools::types::tool::ToolKind::Read, "cursor_read"),
        (ezer_tools::types::tool::ToolKind::ListDir, "cursor_ls"),
        (ezer_tools::types::tool::ToolKind::Search, "cursor_grep"),
    ]);
