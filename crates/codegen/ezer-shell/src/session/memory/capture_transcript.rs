...
use ezer_sampling_types::{ContentPart, ConversationItem};
...
mod tests {
    ...
    fn reasoning(text: String) -> ConversationItem {
        ConversationItem::Reasoning(ezer_sampling_types::synthesized_reasoning_item(text))
    }
    ...
    fn tool_loop(steps: usize, result_bytes: usize) -> Vec<ConversationItem> {
        ...
        for step in 0..steps {
            ...
            if let ConversationItem::Assistant(a) = &mut assistant {
                a.tool_calls.push(ezer_sampling_types::ToolCall {
