//! Rendering helpers for [`CompactionStateContext`] that depend on shell-specific types (`ezer_tools::MemoryBackend`, memory context).
//!
...
//!
//! The **common** active-agent section (Running Background Tasks: commands, loops, workflows, subagents) plus TODO is formatted by [`ezer_compaction::reminder`].
//! That keeps ezer-chat and ezer-build in lockstep.
...
pub fn to_system_reminder_sync(
    ...
    skills: &[ezer_tools::implementations::skills::types::SkillInfo],
...
pub async fn to_system_reminder(
    ...
    discovered_agents_md: &[PathBuf],
    skills: &[ezer_tools::implementations::skills::types::SkillInfo],
    memory_backend: Option<&dyn ezer_tools::types::memory_backend::MemoryBackend>,
    subagent_tool_names: Option<&SubagentToolNames>,
    mcp_tool_names: Option<&McpToolNames>,
    workflow_listing: Option<&str>,
) -> Option<String> {
...
fn to_system_reminder_inner(
    ...
    discovered_agents_md: &[PathBuf],
    skills: &[ezer_tools::implementations::skills::types::SkillInfo],
    memory_results: &[ezer_tools::types::memory_backend::MemorySearchResult],
    subagent_tool_names: Option<&SubagentToolNames>,
    mcp_tool_names: Option<&McpToolNames>,
    workflow_listing: Option<&str>,
) -> Option<String> {
    ...
    if let Some(listing) =
        ezer_tools::types::skill_discovery_tracker::format_compaction_skill_listing(skills)
    {
    ...
    if !ctx.connected_mcp_servers.is_empty() {
        use ezer_tools::implementations::search_tool::format_compaction_server_line;
...
- linear (12 tools)
    ...
    fn system_reminder_places_workflows_below_skills() {
        ...
        let skills = [ezer_tools::implementations::skills::types::SkillInfo {
            name: "commit".into(),
