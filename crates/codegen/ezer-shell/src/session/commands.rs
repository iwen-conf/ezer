...
use ezer_tools::types::skill_discovery_tracker::SkillUpdateKind;
...
pub struct ForkedToolSnapshot {
    pub specs: Vec<ezer_sampling_types::ToolSpec>,
...
pub enum SideQuestionError {
    ...
    Sampling(#[from] ezer_sampling_types::SamplingError),
...
pub fn meta_category_str(
    category: ezer_session_events::types::CancellationCategory,
) -> &'static str {
...
pub struct CurrentModel {
    pub id: String,
    pub reasoning_effort: Option<ezer_sampling_types::ReasoningEffort>,
}
pub enum SessionCommand {
    ...
    GetToolOverrides {
        respond_to: oneshot::Sender<Option<ezer_sampling_types::ToolOverrides>>,
    },
    ...
    SetToolOverrides {
        overrides: ezer_sampling_types::ToolOverrides,
    },
    Prompt {
        prompt_id: String,
        ...
        tool_overrides_update: Option<ezer_sampling_types::ToolOverridesUpdate>,
    ...
    SetReasoningEffort {
        effort: ezer_sampling_types::ReasoningEffort,
        responds_to: oneshot::Sender<Result<acp::ModelId, acp::Error>>,
    },
    ...
    ReloadPlugins {
        registry: Option<std::sync::Arc<ezer_agent::plugins::PluginRegistry>>,
    },
    ...
    /// Capture every finished or stopped turn now for `ezer/memory/flush`.
    FlushMemory {
    ...
    KillBackgroundTask {
        ...
        respond_to: oneshot::Sender<Result<ezer_tools::types::KillOutcome, String>>,
    },
    DeleteScheduledTask {
        task_id: String,
    ...
    TakeHarnessTraceTurns {
        respond_to:
            oneshot::Sender<Vec<Vec<ezer_sampling_types::conversation::ConversationItem>>>,
    },
