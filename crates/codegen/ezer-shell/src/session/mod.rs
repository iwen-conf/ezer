...
pub(crate) fn is_cursor_user_template(
    _template: &ezer_agent::prompt::user_message::UserMessageTemplate,
) -> bool {
    false
}
...
pub(crate) fn is_cursor_system_template(
    _template: &ezer_agent::prompt::context::TemplateOverride,
) -> bool {
    false
}
...
pub use ezer_shared::session::info;
pub mod managed_mcp;
...
pub use ezer_shared::placeholder_images;
pub mod plan_mode;
