use ezer_telemetry::enums::PermissionMode;
...
pub(crate) fn canonical_permission_tool_name(
    access: &ezer_workspace::permission::AccessKind,
) -> String {
    ezer_workspace::permission::prompter_tool_name_for_access(access)
}
...
mod permission_analytics_tests {
    ...
    use ezer_workspace::permission::{ClassifierSecurityFinding, reasons};
    ...
    fn renamed_agent_message_keeps_canonical_product_and_external_identity() {
        let access = ezer_workspace::permission::AccessKind::AgentMessage {
    ...
    fn prompt_outcome_covers_manager_vocabulary() {
        use ezer_workspace::permission::PromptOutcomeKind;
    ...
    fn prompt_outcome_detail_matches_manager_vocabulary() {
        use std::collections::BTreeSet;
        use ezer_telemetry::events::PermissionPromptOutcomeDetail;
        use ezer_workspace::permission::PromptOutcomeKind;
    ...
    fn classifier_source_enum_matches_manager_vocabulary() {
        use std::collections::BTreeSet;
        use ezer_workspace::permission::ClassifierSourceKind;
    ...
    fn classifier_verdict_enum_matches_manager_vocabulary() {
        use std::collections::BTreeSet;
        use ezer_workspace::permission::ClassifierVerdict;
