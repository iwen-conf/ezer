...
pub(crate) fn direct_origin(
    source: ezer_tools::types::tool_call_origin::InvocationSource,
    invocation_id: &str,
...
pub(crate) fn invocation_source(origin: Option<&ToolCallOrigin>) -> Option<InvocationSource> {
    origin.map(|origin| match origin.source() {
        ezer_tools::types::tool_call_origin::InvocationSource::Model => InvocationSource::Model,
        ezer_tools::types::tool_call_origin::InvocationSource::UserDirect => {
            InvocationSource::UserDirect
        }
        ezer_tools::types::tool_call_origin::InvocationSource::System => {
...
fn grok_build_read_id() -> &'static str {
    ...
    ID.get_or_init(|| format!("{}:{}", ToolNamespace::EzerBuild, ReadFileTool.id()))
        .as_str()
}
...
fn map_output_limit(
    limit: ezer_tools::types::source_summary::ToolOutputLimit,
) -> ToolOutputLimit {
    match limit {
        ezer_tools::types::source_summary::ToolOutputLimit::Unobserved => {
            ToolOutputLimit::Unobserved
        }
        ezer_tools::types::source_summary::ToolOutputLimit::NotLimited => {
            ToolOutputLimit::NotLimited
        }
        ezer_tools::types::source_summary::ToolOutputLimit::Limited => ToolOutputLimit::Limited,
    }
}
...
fn map_role(role: ezer_tools::types::source_summary::ReadRole) -> ReadFileRole {
    use ezer_tools::types::source_summary::ReadRole;
    match role {
...
fn map_match(skill_match: ezer_tools::types::source_summary::RegistryMatch) -> ReadSkillMatch {
    use ezer_tools::types::source_summary::RegistryMatch;
    match skill_match {
...
fn map_selection(selection: ezer_tools::types::source_summary::ReadSelection) -> ReadSelection {
    use ezer_tools::types::source_summary::ReadSelection as SourceSelection;
    match selection {
...
fn map_kind(kind: ezer_tools::types::source_summary::ReadLimitKind) -> ReadLimitKind {
    use ezer_tools::types::source_summary::ReadLimitKind as SourceKind;
    match kind {
...
fn map_applicability(
    applicability: ezer_tools::types::source_summary::CapApplicability,
) -> CapApplicability {
    use ezer_tools::types::source_summary::CapApplicability as SourceApplicability;
    match applicability {
...
fn map_disposition(
    disposition: ezer_tools::types::source_summary::CapDisposition,
) -> CapDisposition {
    use ezer_tools::types::source_summary::CapDisposition as SourceDisposition;
    match disposition {
