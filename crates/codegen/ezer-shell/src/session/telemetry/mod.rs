...
use ezer_telemetry::events::SessionHarness;
...
pub(crate) fn format_hook_name(spec: &ezer_hooks::config::HookSpec) -> String {
...
fn format_hook_source(spec: &ezer_hooks::config::HookSpec) -> &'static str {
    use ezer_hooks::config::HookOrigin as O;
    match ezer_hooks::config::hook_origin(spec) {
...
impl HookRegInfo {
    pub(crate) fn from_spec(spec: &ezer_hooks::config::HookSpec) -> Self {
        Self {
...
pub(crate) struct SessionHarnessMetrics {
    ...
    pub permission_mode: ezer_telemetry::enums::PermissionMode,
    pub mcp_server_names: Vec<String>,
    pub lsp_server_names: Vec<String>,
    pub memory_enabled: bool,
    pub memory_retrieval_mode: ezer_telemetry::events::MemoryRetrievalMode,
    ...
    pub compat: ezer_tools::types::compat::CompatConfig,
...
impl SessionHarnessMetrics {
    pub(crate) async fn into_event(self, hooks: Vec<HookRegInfo>) -> SessionHarness {
        ...
        let agents_md_dir_names = ezer_agent::prompt::agents_md::read_agents_config_with_paths(
            &self.cwd,
            self.compat,
            &self.paths_config,
        ...
        SessionHarness {
            ...
            is_git_repo: ezer_telemetry::context::collect_git_context(&self.cwd).is_git_repo,
...
mod is_same_skill_file_tests {
    ...
    fn matches_identical_paths() {
        assert!(is_same_skill_file(
            Path::new("/home/u/.ezer/skills/review/SKILL.md"),
            Path::new("/home/u/.ezer/skills/review/SKILL.md")
        ));
    }
    ...
    fn rejects_a_different_skill() {
        assert!(!is_same_skill_file(
            Path::new("/home/u/.ezer/skills/review/SKILL.md"),
            Path::new("/home/u/.ezer/skills/design/SKILL.md")
        ));
    }
