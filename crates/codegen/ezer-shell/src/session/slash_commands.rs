...
use ezer_tools::implementations::skills::skill::format_skill_name;
use ezer_tools::implementations::skills::types::{SkillInfo, SkillScope};
...
pub(crate) async fn product_skill_infos(
    auth: Option<std::sync::Arc<ezer_login::AuthManager>>,
...
pub(super) async fn build_skill_information_for_refs(
    ...
    use ezer_tools::implementations::skills::skill::{
...
/// The wording (usage hint and scheduling instruction) is sourced from `ezer-tools`.
