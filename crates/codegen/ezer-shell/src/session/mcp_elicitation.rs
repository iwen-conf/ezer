...
use ezer_mcp::elicitation::{
    ElicitationInbox, ElicitationJob, cancel_result, elicit_result_from_wire,
};
use ezer_mcp::wire::MCP_ELICIT;
use ezer_tools::mcp_elicitation::{McpElicitExtRequest, McpElicitExtResponse};
...
mod tests {
    use super::*;
    use ezer_mcp::elicitation::wire_mode_and_fields;
    use ezer_mcp::rmcp::model::{
