...
//! This re-export keeps every existing `crate::session::prompt_queue::*` and `ezer_shell::session::prompt_queue::*` path resolving without edits.
...
pub const QUEUE_CHANGED_METHOD: &str = "ezer/queue/changed";
