...
use ezer_mcp::oauth_config::{McpOAuthConfig, McpOAuthConfigMap};
use ezer_mcp::servers as inner;
...
pub(crate) fn build_config_resolved_event(
    ...
    let servers = configs
        ...
        .collect();
    ezer_session_events::Event::McpConfigResolved { servers, disabled }
}
