...
use ezer_telemetry::session_ctx::spawn_local_in_session_ctx;
...
pub async fn handle(
    ...
    match args.method.as_ref() {
        ...
        "x.ai/git/worktree/create_from_worktree" => {
            ...
            let result = ops
                .dispatch(
                    &ezer_workspace::workspace_ops::PrepareWorktreeFromWorktreeReq {
                        inner: req.clone(),
                    },
                    None,
                )
        ...
        "x.ai/git/worktree/create_from_worktree_sync" => {
            ...
            let resolved_root = ops
                .dispatch(
                    &ezer_workspace::workspace_ops::GitResolveRootReq {
            ...
            if let Some(git_root) = resolved_root {
                let vcs_kind = ops
                    .dispatch(
                        &ezer_workspace::workspace_ops::DetectVcsKindReq {
                            path: git_root.clone(),
                        },
                        None,
                    )
                    .await
                    .unwrap_or(ezer_workspace::session::git::VcsKind::Git);
                if vcs_kind.is_jj() {
            ...
            let result = ops
                .dispatch(
                    &ezer_workspace::workspace_ops::CreateWorktreeFromWorktreeSyncReq {
                        inner: req.into_wire(),
                    },
                    None,
                )
        ...
        "x.ai/git/worktree/resume_session" => {
            ...
            let agent_id = ezer_telemetry::id::agent_id();
        ...
        "x.ai/git/worktree/detach" => {
            ...
            let result = ops
                .dispatch(
                    &ezer_workspace::workspace_ops::WorktreeDetachReq {
                        id_or_path: req.id_or_path,
        ...
        "x.ai/git/worktree/salvage" => {
            ...
            let result = ops
                .dispatch(
                    &ezer_workspace::workspace_ops::WorktreeSalvageReq {
                        id_or_path: req.id_or_path,
                        out: req.out,
                    },
                    None,
        ...
        "x.ai/git/worktree/clean-artifacts" => {
            ...
            let result = ops
                .dispatch(
                    &ezer_workspace::workspace_ops::WorktreeCleanArtifactsReq {
                        id_or_path: req.id_or_path,
                    },
                    None,
                )
