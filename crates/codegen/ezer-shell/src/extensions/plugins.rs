...
pub(crate) fn loaded_plugin_to_info(plugin: &ezer_agent::plugins::LoadedPlugin) -> PluginInfo {
    use ezer_agent::plugins::discovery::PluginScope as AgentScope;
...
fn origin_to_dto(origin: &ezer_agent::plugins::PluginOrigin) -> PluginOrigin {
...
mod tests {
    use super::*;
    use ezer_agent::plugins::PluginOrigin as AgentOrigin;
    use ezer_agent::plugins::discovery::{PluginId, PluginScope as AgentScope};

    fn make_loaded_plugin(origin: AgentOrigin) -> ezer_agent::plugins::LoadedPlugin {
        let root = std::path::PathBuf::from("/tmp/test-plugin");
        ezer_agent::plugins::LoadedPlugin {
