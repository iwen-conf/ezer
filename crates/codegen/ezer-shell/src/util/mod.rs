...
// The foundation utilities live in `ezer-shell-base` (upstream of this crate so they build in parallel)
// Re-exported at the original paths so existing `crate::util::…` and `ezer_shell::util::…` users compile unchanged
pub use ezer_shell_base::util::*;
