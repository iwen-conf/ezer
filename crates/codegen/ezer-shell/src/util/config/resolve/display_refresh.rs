...
use ezer_config_types::DisplayRefreshSettings;

pub const ENV_DISPLAY_REFRESH_PROBE_ENABLED: &str = "EZER_DISPLAY_REFRESH_PROBE_ENABLED";
pub const ENV_DISPLAY_REFRESH_AUTO_CADENCE: &str = "EZER_DISPLAY_REFRESH_AUTO_CADENCE";
...
/// Same band as env cadence knobs (`EZER_MIN_DRAW_MS` / `EZER_SCROLL_CADENCE_MS`).
