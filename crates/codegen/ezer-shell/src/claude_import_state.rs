...
//
// State is persisted to `~/.ezer/claude_import_state.json`.
...
use ezer_workspace::permission::claude_settings::find_claude_settings_paths;
...
fn state_path() -> PathBuf {
    crate::util::ezer_home::ezer_home().join("claude_import_state.json")
}
