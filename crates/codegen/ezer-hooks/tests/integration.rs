...
use ezer_hooks::discovery::load_hooks;
use ezer_hooks::dispatcher;
use ezer_hooks::event::*;
use ezer_hooks::result::HookDecision;
use ezer_hooks::runner::RunContext;
    ...
    let cases = vec![
        ...
        Case {
            ...
            payload: HookPayload::StopFailure {
                error: ezer_hooks::event::StopFailureKind::RateLimit,
        ...
        Case {
            ...
            payload: HookPayload::StopCancelled {
                reason: ezer_hooks::event::StopCancelledReason::UserInterrupt,
                cancelled_by: ezer_hooks::event::CancelledBy::User,
