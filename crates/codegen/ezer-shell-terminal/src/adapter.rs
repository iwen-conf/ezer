//! Implements `ezer-tools::TerminalBackend` over ACP gateway calls, for bash execution when the client serves the terminal.
...
/// Wraps ezer-shell's ACP gateway to satisfy ezer-tools' TerminalBackend.
