...
use ezer_workspace::file_system::TargetClientId;
...
/// Mirrors `ezer_shell::extensions::routing::send_routed_notification` so this crate does not depend on the shell.
...
const NOTIFICATION_METHOD: &str = "ezer/terminal/pty/notification";
