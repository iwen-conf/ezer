...
| Key | Type / Values | Requirements | Managed | Details |
| --- | --- | --- | --- | --- |
| `cli.auto_update` | `boolean` | `pin` | `user` | Check for CLI updates on launch and show a one-time notice. Never downloads or replaces the binary. Once-flag: `~/.ezer/update-notice.json`. Also EZER_DISABLE_AUTOUPDATER to suppress. |
