...
Learn how to install, configure, and extend ezer, the terminal-based AI coding assistant from SpaceXAI.
...
Automate, script, and integrate ezer with other systems.

| # | Document | Description |
|---|----------|-------------|
| 14 | [Headless Mode and Scripting](14-headless-mode.md) | `ezer -p`, output formats, CI/CD integration, and piping |
