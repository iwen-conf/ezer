...
/// `filename`, `path`, `metadata`) that the ezer SLOP converter uses to
...
pub enum ContentBlock {
    ...
    ///
    /// Optional metadata fields are used by the ezer SLOP converter to
    ...
    /// - `path`: file path on the ezer Computer filesystem
